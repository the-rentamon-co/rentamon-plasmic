...
import sty from "./PlasmicTooltip.module.css"; // plasmic-import: H631TCEpl2Nh/css
...
function PlasmicTooltip__RenderFunc(props: {
  ...
  return (
          ...
          >
            ...
            >
              <React.Fragment>
                {(() => {
                  try {
                    return "همون کدی که برات پیامک شد";
                  } catch (e) {
                    if (
                      e instanceof TypeError ||
                      e?.plasmicType === "PlasmicUndefinedDataError"
    ...
    >
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames("all", "__wab_text", sty.text__iJZf2)}>
            {"I have a tooltip."}
          </div>
        ),
        value: args.children
