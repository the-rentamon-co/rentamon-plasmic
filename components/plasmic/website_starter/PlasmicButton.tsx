...
import sty from "./PlasmicButton.module.css"; // plasmic-import: U5bKCJ5DYhib/css
    ...
    <button
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootcolor_miaanColor]: hasVariant($state, "color", "miaanColor"),
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__ceWgx)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__lQo4P)}
                role={"img"}
              />
            ),
