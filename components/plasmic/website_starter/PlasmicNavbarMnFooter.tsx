...
export type PlasmicNavbarMnFooter__VariantMembers = {};
export type PlasmicNavbarMnFooter__VariantsArgs = {};
type VariantPropType = keyof PlasmicNavbarMnFooter__VariantsArgs;
export const PlasmicNavbarMnFooter__VariantProps = new Array<VariantPropType>();

export type PlasmicNavbarMnFooter__ArgsType = {
  navPage?: string;
  userType?: string;
};
type ArgPropType = keyof PlasmicNavbarMnFooter__ArgsType;
export const PlasmicNavbarMnFooter__ArgProps = new Array<ArgPropType>(
  "navPage",
  "userType"
);

export type PlasmicNavbarMnFooter__OverridesType = {
  navFoot?: Flex__<"div">;
...
function PlasmicNavbarMnFooter__RenderFunc(props: {
  variants: PlasmicNavbarMnFooter__VariantsArgs;
  args: PlasmicNavbarMnFooter__ArgsType;
  overrides: PlasmicNavbarMnFooter__OverridesType;
  forNode?: string;
}) {
    ...
    (hasVariant(globalVariants, "screen", "mobile") ? true : false) ? (
      ...
      >
            ...
            onClick={async event => {
              ...
              $steps["goToProperties2"] =
                ...
                $state.properties.data.status == true
                  ...
                  : undefined;
              if (
                $steps["goToProperties2"] != null &&
                typeof $steps["goToProperties2"] === "object" &&
                typeof $steps["goToProperties2"].then === "function"
              ) {
                $steps["goToProperties2"] = await $steps["goToProperties2"];
              }
            }}
          >
            <Reveal
        ...
        <ApiRequest
          ...
          url={"https://api-v3.miaan.ir/webhook/check_user_pending_request"}
        />
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicNavbarMnFooter__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicNavbarMnFooter__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicNavbarMnFooter__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicNavbarMnFooter__ArgProps,
          internalVariantPropNames: PlasmicNavbarMnFooter__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicNavbarMnFooter__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "navFoot") {
    func.displayName = "PlasmicNavbarMnFooter";
  } else {
    func.displayName = `PlasmicNavbarMnFooter.${nodeName}`;
  }
  return func;
}

export const PlasmicNavbarMnFooter = Object.assign(
  // Top-level PlasmicNavbarMnFooter renders the root element
  makeNodeComponent("navFoot"),
  {
    ...
    internalArgProps: PlasmicNavbarMnFooter__ArgProps
  }
);

export default PlasmicNavbarMnFooter;
/* prettier-ignore-end */
