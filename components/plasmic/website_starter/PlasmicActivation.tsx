          ...
          <Embed
            ...
            code={
              hasVariant(globalVariants, "screen", "mobile")
                ? "<script>\r\n(async function() {\r\n    // \u062c\u0644\u0648\u06af\u06cc\u0631\u06cc \u0627\u0632 \u0627\u062c\u0631\u0627\u06cc \u062a\u06a9\u0631\u0627\u0631\u06cc\r\n    if (window.isDivarAuthProcessing) return;\r\n    window.isDivarAuthProcessing = true;\r\n\r\n    const BASE_N8N = \"https://automation.miaan.ir\"; \r\n    const INITIATOR_URL = `${BASE_N8N}/webhook/api/divar/initiator`;\r\n    const CALLBACK_URL  = `${BASE_N8N}/webhook/api/divar/auth-callback`;\r\n\r\n    // \ud83c\udf6a \u062a\u0627\u0628\u0639 \u0633\u062a \u06a9\u0631\u062f\u0646 \u06a9\u0648\u06a9\u06cc \u0628\u0627 \u062a\u0646\u0638\u06cc\u0645\u0627\u062a \u062f\u0642\u06cc\u0642 SSO \u0634\u0645\u0627\r\n    function setSSOCookie(token) {\r\n        const date = new Date();\r\n        date.setTime(date.getTime() + (30 * 24 * 60 * 60 * 1000)); // 30 \u0631\u0648\u0632 \u0627\u0639\u062a\u0628\u0627\u0631\r\n        \r\n        // \u0646\u06a9\u062a\u0647 \u0645\u0647\u0645: domain \u0631\u0627 \u0628\u0627 \u0646\u0642\u0637\u0647 \u0634\u0631\u0648\u0639 \u06a9\u0646\u06cc\u062f \u062a\u0627 \u0631\u0648\u06cc sso.miaan.ir \u0647\u0645 \u06a9\u0627\u0631 \u06a9\u0646\u062f\r\n        document.cookie = `usso_refresh_token=${token}; domain=.miaan.ir; path=/; expires=${date.toUTCString()}; Secure; SameSite=Lax`;\r\n        \r\n        // \u0633\u062a \u06a9\u0631\u062f\u0646 \u0641\u0644\u06af\u200c\u0647\u0627\u06cc \u062f\u0633\u062a\u0631\u0633\u06cc \u0628\u0631\u0627\u06cc \u0641\u0631\u0627\u0646\u062a\r\n        document.cookie = `usso_refresh_available=true; domain=.miaan.ir; path=/; expires=${date.toUTCString()}`;\r\n        document.cookie = `usso_access_available=true; domain=.miaan.ir; path=/; expires=${date.toUTCString()}`;\r\n    }\r\n\r\n    try {\r\n        const params = new URLSearchParams(window.location.search);\r\n        const code = params.get('code'); \r\n        const postToken = params.get('post_token');\r\n        const returnUrl = params.get('return_url');\r\n\r\n        if (!code && !postToken) {\r\n            window.isDivarAuthProcessing = false;\r\n            return;\r\n        }\r\n\r\n        // ---------------------------------------------------------\r\n        // \u06f1. \u0628\u0627\u0632\u06af\u0634\u062a \u0627\u0632 \u062f\u06cc\u0648\u0627\u0631: \u062f\u0631\u06cc\u0627\u0641\u062a \u062a\u0648\u06a9\u0646 \u0648 \u0644\u0627\u06af\u06cc\u0646\r\n        // ---------------------------------------------------------\r\n        if (code) {\r\n            const response = await fetch(CALLBACK_URL, {\r\n                method: 'POST',\r\n                headers: {'Content-Type': 'application/json'},\r\n                body: JSON.stringify({ code: code })\r\n            });\r\n\r\n            const result = await response.json();\r\n            \r\n            // \u0627\u06af\u0631 \u062a\u0648\u06a9\u0646 \u062f\u0631\u06cc\u0627\u0641\u062a \u0634\u062f\r\n            if (result.status === 'success' && result.refresh_token) {\r\n                \r\n                // 1. \u0630\u062e\u06cc\u0631\u0647 \u06a9\u0648\u06a9\u06cc \u0627\u0635\u0644\u06cc \u0628\u0631\u0627\u06cc SSO\r\n                setSSOCookie(result.refresh_token);\r\n\r\n                // 2. \u0646\u0634\u0627\u0646\u06af\u0631 \u0644\u0627\u06af\u06cc\u0646 \u0645\u062d\u0644\u06cc (\u0627\u062e\u062a\u06cc\u0627\u0631\u06cc)\r\n                localStorage.setItem('is_logged_in', 'true');\r\n\r\n                // 3. \u062a\u0645\u06cc\u0632 \u06a9\u0631\u062f\u0646 URL\r\n                const cleanUrl = window.location.protocol + \"//\" + window.location.host + window.location.pathname;\r\n                window.history.replaceState({path: cleanUrl}, '', cleanUrl);\r\n\r\n                // 4. \u0631\u0641\u0631\u0634 \u0635\u0641\u062d\u0647 (\u062d\u0627\u0644\u0627 \u06a9\u0647 \u06a9\u0648\u06a9\u06cc \u0633\u062a \u0634\u062f\u0647\u060c \u0633\u0627\u06cc\u062a \u0634\u0645\u0627 \u0628\u0627 \u062a\u0648\u06a9\u0646 \u0628\u0627\u0644\u0627 \u0645\u06cc\u200c\u0622\u06cc\u062f)\r\n                window.location.reload(); \r\n            }\r\n            return;\r\n        }\r\n\r\n        // ---------------------------------------------------------\r\n        // \u06f2. \u0634\u0631\u0648\u0639 \u067e\u0631\u0648\u0633\u0647\r\n        // ---------------------------------------------------------\r\n        if (postToken) {\r\n            const response = await fetch(INITIATOR_URL, {\r\n                method: 'POST',\r\n                headers: {'Content-Type': 'application/json'},\r\n                body: JSON.stringify({\r\n                    post_token: postToken,\r\n                    return_url: returnUrl\r\n                })\r\n            });\r\n            const data = await response.json();\r\n            if (data && data.auth_url) {\r\n                window.location.href = data.auth_url;\r\n            }\r\n        }\r\n\r\n    } catch (error) {\r\n        console.error(\"Auth Error:\", error);\r\n        window.isDivarAuthProcessing = false;\r\n    }\r\n})();\r\n</script>"
                : hasVariant(globalVariants, "screen", "tablet")
                  ? "<script>\r\n(async function() {\r\n    // \ud83d\udd12 \u062c\u0644\u0648\u06af\u06cc\u0631\u06cc \u0627\u0632 \u0627\u062c\u0631\u0627\u06cc \u062a\u06a9\u0631\u0627\u0631\u06cc\r\n    if (window.isDivarAuthProcessing) return;\r\n    window.isDivarAuthProcessing = true;\r\n\r\n    // \ud83d\udc47 \u062a\u0646\u0638\u06cc\u0645\u0627\u062a \u0622\u062f\u0631\u0633\u200c\u0647\u0627\r\n    const BASE_N8N = \"https://automation.miaan.ir\"; \r\n    const INITIATOR_URL = `${BASE_N8N}/webhook/api/divar/initiator`;\r\n\r\n    try {\r\n        const params = new URLSearchParams(window.location.search);\r\n        const postToken = params.get('post_token');\r\n        const returnUrl = params.get('return_url');\r\n\r\n        // \u0627\u06af\u0631 post_token \u0646\u06cc\u0633\u062a\u060c \u06cc\u0639\u0646\u06cc \u06a9\u0627\u0631 \u0645\u0627 \u0627\u06cc\u0646\u062c\u0627 \u062a\u0645\u0627\u0645 \u0627\u0633\u062a\r\n        if (!postToken) {\r\n            window.isDivarAuthProcessing = false;\r\n            return;\r\n        }\r\n\r\n        // ---------------------------------------------------------\r\n        // \u0645\u0631\u062d\u0644\u0647 \u0634\u0631\u0648\u0639: \u062f\u0631\u062e\u0648\u0627\u0633\u062a \u0644\u06cc\u0646\u06a9 \u0644\u0627\u06af\u06cc\u0646 \u0627\u0632 n8n \u0648 \u0631\u06cc\u062f\u0627\u06cc\u0631\u06a9\u062a\r\n        // ---------------------------------------------------------\r\n        const response = await fetch(INITIATOR_URL, {\r\n            method: 'POST',\r\n            headers: {'Content-Type': 'application/json'},\r\n            body: JSON.stringify({\r\n                post_token: postToken,\r\n                return_url: returnUrl\r\n            })\r\n        });\r\n\r\n        const data = await response.json();\r\n\r\n        if (data && data.auth_url) {\r\n            // \u067e\u0631\u0634 \u0628\u0647 \u0635\u0641\u062d\u0647 \u0645\u062c\u0648\u0632 \u062f\u06cc\u0648\u0627\u0631\r\n            window.location.href = data.auth_url;\r\n        }\r\n\r\n    } catch (error) {\r\n        console.error(\"Auth Logic Error:\", error);\r\n        window.isDivarAuthProcessing = false;\r\n    }\r\n})();\r\n</script>"
                  : "<script>\r\n(async function() {\r\n    if (window.isDivarAuthProcessing) return;\r\n    window.isDivarAuthProcessing = true;\r\n\r\n    const BASE_N8N = \"https://automation.miaan.ir\"; \r\n    const INITIATOR_URL = `${BASE_N8N}/webhook/api/divar`;\r\n    const CALLBACK_URL  = `${BASE_N8N}/webhook/api/divar/auth-callback`;\r\n\r\n    // --- \u062a\u0648\u0627\u0628\u0639 \u06a9\u0645\u06a9\u06cc ---\r\n    function getCookie(name) {\r\n        const value = `; ${document.cookie}`;\r\n        const parts = value.split(`; ${name}=`);\r\n        if (parts.length === 2) return parts.pop().split(\";\").shift();\r\n        return null;\r\n    }\r\n\r\n    function setSSOCookie(token, userId) {\r\n        const date = new Date();\r\n        date.setTime(date.getTime() + (30 * 24 * 60 * 60 * 1000)); \r\n        const expires = date.toUTCString();\r\n        const commonOptions = `domain=.miaan.ir; path=/; expires=${expires}`;\r\n        document.cookie = `usso_refresh_token=${token}; ${commonOptions}; Secure; SameSite=Lax`;\r\n        document.cookie = `usso_refresh_available=true; ${commonOptions}`;\r\n        document.cookie = `usso_access_available=true; ${commonOptions}`;\r\n        document.cookie = `source=divar; ${commonOptions}; Secure; SameSite=Lax`;\r\n        if(userId) document.cookie = `usso_user_id=${userId}; ${commonOptions}; Secure; SameSite=Lax`;\r\n    }\r\n\r\n    try {\r\n        const params = new URLSearchParams(window.location.search);\r\n        const code = params.get('code'); \r\n        const postToken = params.get('post_token');\r\n        const returnUrl = params.get('return_url');\r\n\r\n        // \ud83d\udd25 \u0628\u062e\u0634 \u062c\u062f\u06cc\u062f: \u0686\u06a9 \u06a9\u0631\u062f\u0646 \u0627\u06cc\u0646\u06a9\u0647 \u0622\u06cc\u0627 \u06a9\u0627\u0631\u0628\u0631 \u0644\u0627\u06af\u06cc\u0646 \u0627\u0633\u062a\u061f\r\n        // \u0627\u06af\u0631 \u06a9\u0627\u0631\u0628\u0631 \u0644\u0627\u06af\u06cc\u0646 \u0628\u0648\u062f \u0648\u0644\u06cc \u0627\u0634\u062a\u0628\u0627\u0647\u0627\u064b \u0628\u0647 \u0627\u06cc\u0646\u062c\u0627 \u0631\u06cc\u062f\u0627\u06cc\u0631\u06a9\u062a \u0634\u062f\u060c \u0628\u0631\u0634 \u06af\u0631\u062f\u0627\u0646!\r\n        const currentRefreshToken = getCookie(\"usso_refresh_token\");\r\n        if (currentRefreshToken && currentRefreshToken.length > 20 && !code) {\r\n             const queryParam = postToken ? `?post_token=${postToken}` : '';\r\n             // \u0647\u062f\u0627\u06cc\u062a \u0645\u062c\u062f\u062f \u0628\u0647 \u0635\u0641\u062d\u0647 \u0627\u0635\u0644\u06cc \u0628\u0648\u06a9\u06cc\u0646\u06af\r\n             window.location.href = `https://miaan.ir/direct-booking/select-property${queryParam}`;\r\n             return;\r\n        }\r\n\r\n        // --- \u0628\u0642\u06cc\u0647 \u0645\u0646\u0637\u0642 \u0639\u0627\u062f\u06cc (\u0628\u0631\u0627\u06cc \u0648\u0642\u062a\u06cc \u06a9\u0647 \u06a9\u0627\u0631\u0628\u0631 \u0648\u0627\u0642\u0639\u0627 \u0644\u0627\u06af\u06cc\u0646 \u0646\u06cc\u0633\u062a) ---\r\n\r\n        if (!code && !postToken) {\r\n            window.isDivarAuthProcessing = false;\r\n            return;\r\n        }\r\n\r\n        // \u0627\u06af\u0631 \u0627\u06cc\u0646\u062c\u0627 \u0647\u0645 \u06a9\u062f\u06cc \u0648\u062c\u0648\u062f \u062f\u0627\u0634\u062a (\u0645\u062b\u0644\u0627 \u0645\u0633\u062a\u0642\u06cc\u0645 \u0628\u0647 \u0627\u06a9\u062a\u06cc\u0648\u06cc\u0634\u0646 \u06a9\u0627\u0644 \u0628\u06a9 \u0632\u062f\u0647 \u0634\u062f)\r\n        if (code) {\r\n            const response = await fetch(CALLBACK_URL, {\r\n                method: 'POST',\r\n                headers: {'Content-Type': 'application/json'},\r\n                body: JSON.stringify({ code: code })\r\n            });\r\n\r\n            const result = await response.json();\r\n            \r\n            if (result.status === 'success' && result.refresh_token) {\r\n                setSSOCookie(result.refresh_token, result.user_id);\r\n                localStorage.setItem('is_logged_in', 'true');\r\n\r\n                const cleanUrl = window.location.protocol + \"//\" + window.location.host + window.location.pathname;\r\n                window.history.replaceState({path: cleanUrl}, '', cleanUrl);\r\n\r\n                // \u0628\u0639\u062f \u0627\u0632 \u0644\u0627\u06af\u06cc\u0646 \u0645\u0648\u0641\u0642 \u062f\u0631 \u0635\u0641\u062d\u0647 \u0627\u06a9\u062a\u06cc\u0648\u06cc\u0634\u0646\u060c \u0631\u06cc\u0644\u0648\u062f \u06a9\u0646 \u06cc\u0627 \u0628\u0631\u0648 \u0628\u0647 \u0635\u0641\u062d\u0647 \u0645\u0642\u0635\u062f\r\n                if (postToken) {\r\n                     window.location.href = `https://miaan.ir/direct-booking/select-property?post_token=${postToken}`;\r\n                } else {\r\n                     window.location.reload(); \r\n                }\r\n            }\r\n            return;\r\n        }\r\n\r\n        if (postToken) {\r\n            const response = await fetch(INITIATOR_URL, {\r\n                method: 'POST',\r\n                headers: {'Content-Type': 'application/json'},\r\n                body: JSON.stringify({\r\n                    post_token: postToken,\r\n                    return_url: returnUrl,\r\n                    source: \"DEMAND_POST\"\r\n                })\r\n            });\r\n            const data = await response.json();\r\n            if (data && data.url) {\r\n                window.location.href = data.url;\r\n            }\r\n        }\r\n\r\n    } catch (error) {\r\n        console.error(\"Auth Error:\", error);\r\n        window.isDivarAuthProcessing = false;\r\n    }\r\n})();\r\n</script>"
            }
          />
