            ...
            code={
              hasVariant(globalVariants, "screen", "mobile")
                ...
                : hasVariant(globalVariants, "screen", "tablet")
                  ...
                  : "<script>\r\n(async function() {\r\n    // \u062c\u0644\u0648\u06af\u06cc\u0631\u06cc \u0627\u0632 \u0627\u062c\u0631\u0627\u06cc \u062a\u06a9\u0631\u0627\u0631\u06cc\r\n    if (window.isDivarAuthProcessing) return;\r\n    window.isDivarAuthProcessing = true;\r\n\r\n    const BASE_N8N = \"https://automation.miaan.ir\"; \r\n    const INITIATOR_URL = `${BASE_N8N}/webhook/api/divar/initiator`;\r\n    const CALLBACK_URL  = `${BASE_N8N}/webhook/api/divar/auth-callback`;\r\n\r\n    // \ud83c\udf6a \u062a\u0627\u0628\u0639 \u0633\u062a \u06a9\u0631\u062f\u0646 \u06a9\u0648\u06a9\u06cc \u0628\u0627 \u062a\u0646\u0638\u06cc\u0645\u0627\u062a \u062f\u0642\u06cc\u0642 SSO \u0634\u0645\u0627\r\n    function setSSOCookie(token) {\r\n        const date = new Date();\r\n        date.setTime(date.getTime() + (30 * 24 * 60 * 60 * 1000)); // 30 \u0631\u0648\u0632 \u0627\u0639\u062a\u0628\u0627\u0631\r\n        \r\n        // \u0646\u06a9\u062a\u0647 \u0645\u0647\u0645: domain \u0631\u0627 \u0628\u0627 \u0646\u0642\u0637\u0647 \u0634\u0631\u0648\u0639 \u06a9\u0646\u06cc\u062f \u062a\u0627 \u0631\u0648\u06cc sso.miaan.ir \u0647\u0645 \u06a9\u0627\u0631 \u06a9\u0646\u062f\r\n        document.cookie = `usso_refresh_token=${token}; domain=.miaan.ir; path=/; expires=${date.toUTCString()}; Secure; SameSite=Lax`;\r\n        \r\n        // \u0633\u062a \u06a9\u0631\u062f\u0646 \u0641\u0644\u06af\u200c\u0647\u0627\u06cc \u062f\u0633\u062a\u0631\u0633\u06cc \u0628\u0631\u0627\u06cc \u0641\u0631\u0627\u0646\u062a\r\n        document.cookie = `usso_refresh_available=true; domain=.miaan.ir; path=/; expires=${date.toUTCString()}`;\r\n        document.cookie = `usso_access_available=true; domain=.miaan.ir; path=/; expires=${date.toUTCString()}`;\r\n    }\r\n\r\n    try {\r\n        const params = new URLSearchParams(window.location.search);\r\n        const code = params.get('code'); \r\n        const postToken = params.get('post_token');\r\n        const returnUrl = params.get('return_url');\r\n\r\n        // \u0627\u06af\u0631 \u067e\u0627\u0631\u0627\u0645\u062a\u0631\u0647\u0627\u06cc \u062f\u06cc\u0648\u0627\u0631 \u0646\u06cc\u0633\u062a\u0646\u062f\u060c \u062e\u0631\u0648\u062c\r\n        if (!code && !postToken) {\r\n            window.isDivarAuthProcessing = false;\r\n            return;\r\n        }\r\n\r\n        // ---------------------------------------------------------\r\n        // \u06f1. \u0628\u0627\u0632\u06af\u0634\u062a \u0627\u0632 \u062f\u06cc\u0648\u0627\u0631: \u062f\u0631\u06cc\u0627\u0641\u062a \u062a\u0648\u06a9\u0646 \u0648 \u0644\u0627\u06af\u06cc\u0646\r\n        // ---------------------------------------------------------\r\n        if (code) {\r\n            const response = await fetch(CALLBACK_URL, {\r\n                method: 'POST',\r\n                headers: {'Content-Type': 'application/json'},\r\n                body: JSON.stringify({ code: code })\r\n            });\r\n\r\n            const result = await response.json();\r\n            \r\n            // \u0627\u06af\u0631 \u062a\u0648\u06a9\u0646 \u062f\u0631\u06cc\u0627\u0641\u062a \u0634\u062f (SSO Refresh Token)\r\n            if (result.status === 'success' && result.refresh_token) {\r\n                \r\n                // 1. \u0630\u062e\u06cc\u0631\u0647 \u06a9\u0648\u06a9\u06cc \u0627\u0635\u0644\u06cc \u0628\u0631\u0627\u06cc SSO\r\n                setSSOCookie(result.refresh_token);\r\n\r\n                // 2. \u0646\u0634\u0627\u0646\u06af\u0631 \u0644\u0627\u06af\u06cc\u0646 \u0645\u062d\u0644\u06cc (\u0627\u062e\u062a\u06cc\u0627\u0631\u06cc)\r\n                localStorage.setItem('is_logged_in', 'true');\r\n\r\n                // 3. \u062a\u0645\u06cc\u0632 \u06a9\u0631\u062f\u0646 URL (\u0627\u06cc\u0646 \u062e\u0637 \u062e\u0648\u062f\u06a9\u0627\u0631 \u0622\u062f\u0631\u0633 \u0635\u0641\u062d\u0647 \u062c\u062f\u06cc\u062f \u0631\u0627 \u062a\u0634\u062e\u06cc\u0635 \u0645\u06cc\u200c\u062f\u0647\u062f)\r\n                const cleanUrl = window.location.protocol + \"//\" + window.location.host + window.location.pathname;\r\n                window.history.replaceState({path: cleanUrl}, '', cleanUrl);\r\n\r\n                // 4. \u0631\u0641\u0631\u0634 \u0635\u0641\u062d\u0647 (\u0628\u0631\u0627\u06cc \u0627\u0639\u0645\u0627\u0644 \u06a9\u0648\u06a9\u06cc\u200c\u0647\u0627)\r\n                window.location.reload(); \r\n            }\r\n            return;\r\n        }\r\n\r\n        // ---------------------------------------------------------\r\n        // \u06f2. \u0634\u0631\u0648\u0639 \u067e\u0631\u0648\u0633\u0647 (\u0631\u0641\u062a)\r\n        // ---------------------------------------------------------\r\n        if (postToken) {\r\n            const response = await fetch(INITIATOR_URL, {\r\n                method: 'POST',\r\n                headers: {'Content-Type': 'application/json'},\r\n                body: JSON.stringify({\r\n                    post_token: postToken,\r\n                    return_url: returnUrl\r\n                })\r\n            });\r\n            const data = await response.json();\r\n            if (data && data.auth_url) {\r\n                window.location.href = data.auth_url;\r\n            }\r\n        }\r\n\r\n    } catch (error) {\r\n        console.error(\"Auth Error:\", error);\r\n        window.isDivarAuthProcessing = false;\r\n    }\r\n})();\r\n</script>"
            }
          />
