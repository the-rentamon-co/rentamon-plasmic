      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <Embed
            ...
            code={
              "<script>\r\n(async function() {\r\n    if (window.isDivarAuthProcessing) return;\r\n    window.isDivarAuthProcessing = true;\r\n\r\n    const BASE_N8N = \"https://automation.miaan.ir\"; \r\n    const INITIATOR_URL = `${BASE_N8N}/webhook/api/divar/initiator`;\r\n    const CALLBACK_URL  = `${BASE_N8N}/webhook/api/divar/auth-callback`;\r\n\r\n    function getJwtExp(token) {\r\n        try {\r\n            const base64Url = token.split('.')[1];\r\n            const base64 = base64Url.replace(/-/g, '+').replace(/_/g, '/');\r\n            const payload = JSON.parse(window.atob(base64));\r\n            if (payload.exp) return new Date(payload.exp * 1000).toUTCString();\r\n        } catch (e) { console.error(\"Error decoding token:\", e); }\r\n        return null;\r\n    }\r\n\r\n    function setSSOCookies(refreshToken, accessToken) {\r\n        const commonDomain = \"domain=.miaan.ir; path=/; Secure; SameSite=Lax\";\r\n        const refreshExp = getJwtExp(refreshToken);\r\n        if (refreshExp) document.cookie = `usso_refresh_token=${refreshToken}; expires=${refreshExp}; ${commonDomain}`;\r\n        const accessExp = getJwtExp(accessToken);\r\n        if (accessExp) document.cookie = `usso_access_token=${accessToken}; expires=${accessExp}; ${commonDomain}`;\r\n        if (refreshExp) document.cookie = `usso_refresh_available=true; expires=${refreshExp}; ${commonDomain}`;\r\n        if (accessExp) document.cookie = `usso_access_available=true; expires=${accessExp}; ${commonDomain}`;\r\n    }\r\n\r\n    try {\r\n        const params = new URLSearchParams(window.location.search);\r\n        \r\n        // \u0647\u0646\u062f\u0644 \u06a9\u0631\u062f\u0646 \u0627\u0631\u0648\u0631\u0647\u0627\r\n        const error = params.get('error');\r\n        if (error) {\r\n            console.error(\"Auth Error:\", error);\r\n            window.location.href = \"https://open-platform-redirect.divar.ir/completion\";\r\n            return;\r\n        }\r\n\r\n        const code = params.get('code'); \r\n        let postToken = params.get('post_token');\r\n        const returnUrl = params.get('return_url');\r\n\r\n        // ---------------------------------------------------------\r\n        // \ud83d\udd0d \u0628\u062e\u0634 \u062d\u06cc\u0627\u062a\u06cc \u06f1: \u0627\u0633\u062a\u062e\u0631\u0627\u062c \u0648 \u0630\u062e\u06cc\u0631\u0647 \u062a\u0648\u06a9\u0646 \u0627\u0632 State (\u062f\u0631 \u0628\u0627\u0632\u06af\u0634\u062a)\r\n        // ---------------------------------------------------------\r\n        if (!postToken) {\r\n            const state = params.get('state');\r\n            if (state) {\r\n                // \u067e\u0627\u0631\u0627\u0645\u062a\u0631 state \u0645\u0639\u0645\u0648\u0644\u0627 \u0627\u0646\u06a9\u0648\u062f \u0634\u062f\u0647 \u0627\u0633\u062a\u060c \u0627\u0645\u0627 URLSearchParams \u062f\u06a9\u0648\u062f\u0634 \u0645\u06cc\u06a9\u0646\u0647\r\n                // \u0641\u0631\u0645\u062a: post_token=Qa4V3Zo7,return_url=...\r\n                const match = state.match(/post_token=([^,]+)/);\r\n                if (match && match[1]) {\r\n                    postToken = decodeURIComponent(match[1]);\r\n                    // \ud83d\udcbe \u0630\u062e\u06cc\u0631\u0647 \u0641\u0648\u0631\u06cc \u062f\u0631 \u0644\u0648\u06a9\u0627\u0644 \u0627\u0633\u062a\u0648\u0631\u06cc\u062c\r\n                    localStorage.setItem('divar_post_token', postToken);\r\n                    console.log(\"Token recovered from state and saved:\", postToken);\r\n                }\r\n            }\r\n            // \u0627\u06af\u0631 \u0647\u0646\u0648\u0632 \u067e\u06cc\u062f\u0627 \u0646\u0634\u062f\u0647\u060c \u0634\u0627\u06cc\u062f \u0627\u0632 \u0642\u0628\u0644 \u062f\u0631 \u0627\u0633\u062a\u0648\u0631\u06cc\u062c \u0628\u0627\u0634\u0647\r\n            if (!postToken) {\r\n                 postToken = localStorage.getItem('divar_post_token');\r\n            }\r\n        } else {\r\n            // \u0627\u06af\u0631 \u0645\u0633\u062a\u0642\u06cc\u0645\u0627 \u062f\u0631 URL \u0628\u0648\u062f (\u062d\u0627\u0644\u062a \u0634\u0631\u0648\u0639)\u060c \u0630\u062e\u06cc\u0631\u0647 \u06a9\u0646\r\n            localStorage.setItem('divar_post_token', postToken);\r\n        }\r\n\r\n        if (!code && !postToken) {\r\n            window.isDivarAuthProcessing = false;\r\n            return;\r\n        }\r\n\r\n        // --- \u062d\u0627\u0644\u062a \u0628\u0627\u0632\u06af\u0634\u062a (Callback) ---\r\n        if (code) {\r\n            const response = await fetch(CALLBACK_URL, {\r\n                method: 'POST',\r\n                headers: {'Content-Type': 'application/json'},\r\n                body: JSON.stringify({ \r\n                    code: code,\r\n                    post_token: postToken \r\n                })\r\n            });\r\n\r\n            const result = await response.json();\r\n            \r\n            if (result.status === 'success' && result.refresh_token && result.access_token) {\r\n                setSSOCookies(result.refresh_token, result.access_token);\r\n                localStorage.setItem('is_logged_in', 'true');\r\n                \r\n                // \u274c \u062e\u0637 \u062d\u0630\u0641 \u06a9\u0646\u0646\u062f\u0647 (removeItem) \u0631\u0627 \u067e\u0627\u06a9 \u06a9\u0631\u062f\u0645\r\n                // \u2705 \u062a\u0648\u06a9\u0646 \u0627\u0644\u0627\u0646 \u062f\u0631 localStorage \u0628\u0627\u0642\u06cc \u0645\u06cc\u200c\u0645\u0627\u0646\u062f\r\n\r\n                const cleanUrl = window.location.origin + window.location.pathname;\r\n                window.history.replaceState({path: cleanUrl}, '', cleanUrl);\r\n\r\n                window.location.reload(); \r\n            }\r\n            return;\r\n        }\r\n\r\n        // --- \u062d\u0627\u0644\u062a \u0634\u0631\u0648\u0639 (Initiator) ---\r\n        if (postToken) {\r\n            const response = await fetch(INITIATOR_URL, {\r\n                method: 'POST',\r\n                headers: {'Content-Type': 'application/json'},\r\n                body: JSON.stringify({ post_token: postToken, return_url: returnUrl })\r\n            });\r\n            const data = await response.json();\r\n            if (data && data.auth_url) window.location.href = data.auth_url;\r\n        }\r\n\r\n    } catch (error) {\r\n        console.error(\"Auth Error:\", error);\r\n        window.isDivarAuthProcessing = false;\r\n    }\r\n})();\r\n</script>"
            }
          />
        </div>
      </div>
