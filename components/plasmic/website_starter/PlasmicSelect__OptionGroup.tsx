...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: d_b2_mjvC-EH/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: GgjLI5qwOqwu/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__pXjTt)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option___5PHjZ)}
              />
            </React.Fragment>
          ),
          value: args.children
