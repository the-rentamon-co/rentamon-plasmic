...
export type PlasmicSettingsNeo__VariantMembers = {};
export type PlasmicSettingsNeo__VariantsArgs = {};
type VariantPropType = keyof PlasmicSettingsNeo__VariantsArgs;
export const PlasmicSettingsNeo__VariantProps = new Array<VariantPropType>();

export type PlasmicSettingsNeo__ArgsType = {};
type ArgPropType = keyof PlasmicSettingsNeo__ArgsType;
export const PlasmicSettingsNeo__ArgProps = new Array<ArgPropType>();

export type PlasmicSettingsNeo__OverridesType = {
  settings?: Flex__<"div">;
  header?: Flex__<"div">;
...
export interface DefaultSettingsNeoProps {}
...
function PlasmicSettingsNeo__RenderFunc(props: {
  variants: PlasmicSettingsNeo__VariantsArgs;
  args: PlasmicSettingsNeo__ArgsType;
  overrides: PlasmicSettingsNeo__OverridesType;
  forNode?: string;
}) {
              ...
              >
                ...
                >
                  ...
                  >
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img___0Ral9)}
                      displayHeight={
                        hasVariant(globalVariants, "screen", "smallMobile")
                          ? "auto"
                          : hasVariant(globalVariants, "screen", "mobile")
                ...
                >
                  ...
                  >
                    {(
                      ...
                      <PlasmicImg__
                        alt={""}
                        className={classNames(sty.img__fjoR8)}
                        displayHeight={"auto"}
                        displayMaxHeight={"none"}
                        displayMaxWidth={"100%"}
                        displayMinHeight={"0"}
                ...
                >
                  ...
                  >
                    {(
                      ...
                      <PlasmicImg__
                        alt={""}
                        className={classNames(sty.img___1ZU1)}
                        displayHeight={"auto"}
                        displayMaxHeight={"none"}
                        displayMaxWidth={"100%"}
                        displayMinHeight={"0"}
                ...
                >
                  ...
                  >
                    {(
                      ...
                      <PlasmicImg__
                        alt={""}
                        className={classNames(sty.img__uCcha)}
                        displayHeight={"auto"}
                        displayMaxHeight={"none"}
                        displayMaxWidth={"100%"}
                        displayMinHeight={"0"}
                ...
                >
                  ...
                  >
                    {(
                      ...
                      <PlasmicImg__
                        alt={""}
                        className={classNames(sty.img__zSFii)}
                        displayHeight={"auto"}
                        displayMaxHeight={"none"}
                        displayMaxWidth={"100%"}
                        displayMinHeight={"0"}
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicSettingsNeo__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicSettingsNeo__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicSettingsNeo__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicSettingsNeo__ArgProps,
          internalVariantPropNames: PlasmicSettingsNeo__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicSettingsNeo__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "settings") {
    func.displayName = "PlasmicSettingsNeo";
  } else {
    func.displayName = `PlasmicSettingsNeo.${nodeName}`;
  }
  return func;
}

export const PlasmicSettingsNeo = Object.assign(
  // Top-level PlasmicSettingsNeo renders the root element
  makeNodeComponent("settings"),
  {
    ...
    // Metadata about props expected for PlasmicSettingsNeo
    internalVariantProps: PlasmicSettingsNeo__VariantProps,
    internalArgProps: PlasmicSettingsNeo__ArgProps,

    // Key-value metadata
    metadata: { nameRobots: 'content="noindex, nofollow"' },

    pageMetadata: generateDynamicMetadata(wrapQueriesWithLoadingProxy({}), {
      pageRoute: "/settings-neo",
      pagePath: "/settings-neo",
      params: {},
      query: {}
    })
  }
...
export default PlasmicSettingsNeo;
/* prettier-ignore-end */
