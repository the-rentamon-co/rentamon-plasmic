...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: Vs0xTpAY08mF/css
...
function PlasmicCheckboxGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames("all", sty.freeBox__zPush)}>
            <Checkbox2
            ...
            <Checkbox2
              className={classNames("__wab_instance", sty.checkbox2___2KyN)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox2
              className={classNames("__wab_instance", sty.checkbox2__k1Tih)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
