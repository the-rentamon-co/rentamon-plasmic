    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox__ppyHd)}>
        <DatePicker
          ...
          holidays={[
            1710979200, 1711065600, 1711584000, 1711670400, 1712188800,
            1712275200, 1712793600, 1712880000, 1713398400, 1713484800,
            1714003200, 1714089600, 1714608000, 1714694400, 1715212800,
            1715299200, 1715817600, 1715904000, 1716422400, 1716508800,
            1717027200, 1717113600, 1717632000, 1717718400, 1718236800,
            1718323200, 1718841600, 1718928000, 1719446400, 1719532800,
            1720051200, 1720137600, 1720656000, 1720742400, 1721260800,
            1721347200, 1721865600, 1721952000, 1722470400, 1722556800,
            1723075200, 1723161600, 1723680000, 1723766400, 1724284800,
            1724371200, 1724889600, 1724976000, 1725494400, 1725580800,
            1726099200, 1726185600, 1726704000, 1726790400, 1727308800,
            1727395200, 1727913600, 1728000000, 1728518400, 1728604800,
            1729123200, 1729209600, 1729728000, 1729814400, 1730332800,
            1730419200, 1730937600, 1731024000, 1731542400, 1731628800,
            1732147200, 1732233600, 1732752000, 1732838400, 1733356800,
            1733443200, 1733961600, 1734048000, 1734566400, 1734652800,
            1735171200, 1735257600, 1735776000, 1735862400, 1736380800,
            1736467200, 1736985600, 1737072000, 1737590400, 1737676800,
            1738195200, 1738281600, 1738800000, 1738886400, 1739404800,
            1739491200, 1740009600, 1740096000, 1740614400, 1740700800,
            1741219200, 1741305600, 1741824000, 1741910400, 1742428800
          ]}
          locale={"fa"}
          mode={"multiple"}
        ...
        >
          ...
          >
            ...
            {(() => {
              try {
                return (() => {
                  if ($state.numberInput4.value == "10") {
                    return true;
                  } else {
                    return false;
                  }
...
const PlasmicDescendants = {
  ...
  dayCell: ["dayCell"],
  modalDiscount: ["modalDiscount", "numberInput3", "main", "numberInput4"],
