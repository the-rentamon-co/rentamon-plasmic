...
export type PlasmicکیفپولNeo__VariantMembers = {};
export type PlasmicکیفپولNeo__VariantsArgs = {};
type VariantPropType = keyof PlasmicکیفپولNeo__VariantsArgs;
export const PlasmicکیفپولNeo__VariantProps = new Array<VariantPropType>();

export type PlasmicکیفپولNeo__ArgsType = {};
type ArgPropType = keyof PlasmicکیفپولNeo__ArgsType;
export const PlasmicکیفپولNeo__ArgProps = new Array<ArgPropType>();

export type PlasmicکیفپولNeo__OverridesType = {
  wallet?: Flex__<"div">;
  header?: Flex__<"div">;
...
export interface DefaultکیفپولNeoProps {}
...
function PlasmicکیفپولNeo__RenderFunc(props: {
  variants: PlasmicکیفپولNeo__VariantsArgs;
  args: PlasmicکیفپولNeo__ArgsType;
  overrides: PlasmicکیفپولNeo__OverridesType;
  forNode?: string;
}) {
  ...
  const stateSpecs: Parameters<typeof useDollarState>[0] = React.useMemo(
    () => [
      ...
      },
      {
        ...
        type: "private",
        variableType: "text",
        initFunc: ({ $props, $state, $queries, $q, $ctx }) => "1000000"
      },
      {
        ...
        >
          ...
          <AntdModal
            ...
            modalContentClassName={classNames({
              [sty["pcls_fWeeCQ5LEVWb"]]: true,
              [sty["pcls_nV-VI_bQSr83"]]: hasVariant(
                globalVariants,
                "screen",
                "mobile"
              ),
              [sty["pcls_yMPXpOvnpPxP"]]: hasVariant(
                globalVariants,
                "screen",
                "tablet"
              )
            ...
            <div className={classNames("all", sty.freeBox__fGhOu)}>
              ...
              >
                {(() => {
                  ...
                  <PlasmicImg__
                    alt={""}
                    className={classNames(sty.img__ohGh)}
                    displayHeight={"34px"}
            ...
            >
              ...
              >
                {(() => {
                  ...
                  <PlasmicImg__
                    alt={""}
                    className={classNames(sty.img__lx0Qn)}
                    displayHeight={"34px"}
                    displayMaxHeight={"none"}
                    displayMaxWidth={"100%"}
                    displayMinHeight={"0"}
          ...
          >
            ...
            >
              {hasVariant(globalVariants, "screen", "smallMobile")
                ? "\u0628\u0631\u0627\u06cc \u0645\u0634\u0627\u0647\u062f\u0647  \u062a\u0639\u0631\u0641\u0647 \u062e\u062f\u0645\u0627\u062a \u00ab\u0645\u06cc\u0627\u0646\u00bb\u060c \u0627\u06cc\u0646\u062c\u0627 \u0628\u0632\u0646"
                : hasVariant(globalVariants, "screen", "mobile")
                  ? "\u0628\u0631\u0627\u06cc \u0645\u0634\u0627\u0647\u062f\u0647\u200c  \u062a\u0639\u0631\u0641\u0647 \u062e\u062f\u0645\u0627\u062a \u00ab\u0645\u06cc\u0627\u0646\u00bb\u060c \u0627\u06cc\u0646\u062c\u0627 \u0628\u0632\u0646"
                  : hasVariant(globalVariants, "screen", "tablet")
                    ? "\u0628\u0631\u0627\u06cc \u0645\u0634\u0627\u0647\u062f\u0647\u200c  \u062a\u0639\u0631\u0641\u0647 \u062e\u062f\u0645\u0627\u062a \u00ab\u0645\u06cc\u0627\u0646\u00bb\u060c \u0627\u06cc\u0646\u062c\u0627 \u0628\u0632\u0646"
                    : "\u0628\u0631\u0627\u06cc \u0645\u0634\u0627\u0647\u062f\u0647\u200c  \u062a\u0639\u0631\u0641\u0647 \u062e\u062f\u0645\u0627\u062a \u00ab\u0645\u06cc\u0627\u0646\u00bb\u060c \u0628\u0632\u0646 \u0627\u06cc\u0646\u062c\u0627"}
            </div>
          </div>
          <div
                      ...
                      <React.Fragment>
                        ...
                        <AntdAccordionItem
                          ...
                          label2={
                            ...
                            >
                              {
                                "\u0627\u0645\u06a9\u0627\u0646 \u0644\u063a\u0648 \u0639\u0636\u0648\u06cc\u062a \u062f\u0631 \u0628\u0631\u0646\u0627\u0645\u0647 \u00ab\u0645\u06cc\u0627\u0646\u00bb \u0647\u0633\u062a\u061f\r"
                              }
                            </div>
                          }
                          showArrow={true}
          ...
          <SideEffect
            className={classNames("__wab_instance", sty.sideEffect__lYRi7)}
            onMount={async () => {
              const $steps = {};
          ...
          <SideEffect
            className={classNames("__wab_instance", sty.sideEffect__ouape)}
            onMount={async () => {
              const $steps = {};
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicکیفپولNeo__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicکیفپولNeo__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicکیفپولNeo__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicکیفپولNeo__ArgProps,
          internalVariantPropNames: PlasmicکیفپولNeo__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicکیفپولNeo__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "wallet") {
    func.displayName = "Plasmic\u06a9\u06cc\u0641\u067e\u0648\u0644Neo";
  } else {
    func.displayName = `PlasmicکیفپولNeo.${nodeName}`;
  }
  return func;
}

export const PlasmicکیفپولNeo = Object.assign(
  // Top-level PlasmicکیفپولNeo renders the root element
  makeNodeComponent("wallet"),
  {
    ...
    internalVariantProps: PlasmicکیفپولNeo__VariantProps,
    internalArgProps: PlasmicکیفپولNeo__ArgProps,

    // Key-value metadata
    metadata: { robots: "noindex, follow" },

    pageMetadata: generateDynamicMetadata(wrapQueriesWithLoadingProxy({}), {
      pageRoute: "/wallet-neo",
      pagePath: "/wallet-neo",
      params: {},
      query: {}
    })
...
export default PlasmicکیفپولNeo;
/* prettier-ignore-end */
