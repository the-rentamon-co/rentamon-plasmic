...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: aJ__NJr-bNI0/css
...
function PlasmicRangeSlider__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames("all", sty.freeBox__xWvaZ)}>
        {$props.showLabel ? (
          <Label
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div
                  className={classNames("all", "__wab_text", sty.text___2Gh7D)}
                >
                  {"Label"}
                </div>
              ),
      ...
      <div className={classNames("all", sty.freeBox__ajD4M)}>
        <div
