...
import sty from "./PlasmicSplashWithVpnModal.module.css"; // plasmic-import: RJaZxeFbz5F5/css
...
export type PlasmicSplashWithVpnModal__VariantMembers = {};
export type PlasmicSplashWithVpnModal__VariantsArgs = {};
type VariantPropType = keyof PlasmicSplashWithVpnModal__VariantsArgs;
export const PlasmicSplashWithVpnModal__VariantProps =
  new Array<VariantPropType>();

export type PlasmicSplashWithVpnModal__ArgsType = {};
type ArgPropType = keyof PlasmicSplashWithVpnModal__ArgsType;
export const PlasmicSplashWithVpnModal__ArgProps = new Array<ArgPropType>();

export type PlasmicSplashWithVpnModal__OverridesType = {
  root?: Flex__<"div">;
...
export interface DefaultSplashWithVpnModalProps {}
...
function PlasmicSplashWithVpnModal__RenderFunc(props: {
  variants: PlasmicSplashWithVpnModal__VariantsArgs;
  args: PlasmicSplashWithVpnModal__ArgsType;
  overrides: PlasmicSplashWithVpnModal__OverridesType;
  forNode?: string;
}) {
    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__gvpgf)}>
              <div className={classNames(projectcss.all, sty.freeBox__jcZqv)}>
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__oWihg)}
                  displayHeight={"auto"}
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__hhFuz)}
                displayHeight={"119px"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
              ...
              <div className={classNames(projectcss.all, sty.freeBox___8AgJ7)}>
                <Button
          ...
          <div className={classNames(projectcss.all, sty.freeBox__mqTx7)}>
            {(() => {
              try {
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img___48Ej)}
                displayHeight={"auto"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
          ...
          {(() => {
            ...
            <div className={classNames(projectcss.all, sty.freeBox__tIi8)}>
              <div
                className={classNames(
                  projectcss.all,
                  sty.freeBox__s3L8,
              ...
              >
                ...
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__a8Fe)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicSplashWithVpnModal__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicSplashWithVpnModal__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicSplashWithVpnModal__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicSplashWithVpnModal__ArgProps,
          internalVariantPropNames: PlasmicSplashWithVpnModal__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicSplashWithVpnModal__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicSplashWithVpnModal";
  } else {
    func.displayName = `PlasmicSplashWithVpnModal.${nodeName}`;
  }
  return func;
}

export const PlasmicSplashWithVpnModal = Object.assign(
  // Top-level PlasmicSplashWithVpnModal renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicSplashWithVpnModal
    internalVariantProps: PlasmicSplashWithVpnModal__VariantProps,
    internalArgProps: PlasmicSplashWithVpnModal__ArgProps,
...
export default PlasmicSplashWithVpnModal;
/* prettier-ignore-end */
