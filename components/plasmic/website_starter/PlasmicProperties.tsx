          ...
          <Embed
            ...
            code={
              hasVariant(globalVariants, "screen", "mobile")
                ? "<div id=\"auth-loader\" style=\"position:fixed; top:0; left:0; width:100%; height:100%; background:white; z-index:9999; display:flex; flex-direction:column; align-items:center; justify-content:center; font-family:sans-serif; direction:rtl;\">\r\n  <div style=\"width:40px; height:40px; border:4px solid #eee; border-top:4px solid #2727ea; border-radius:50%; animation:spin 1s linear infinite;\"></div>\r\n  <p style=\"margin-top:20px; color:#666;\" id=\"loader-text\">\u062f\u0631 \u062d\u0627\u0644 \u067e\u0631\u062f\u0627\u0632\u0634...</p>\r\n  \r\n  <div id=\"debug-info\" style=\"margin-top:20px; font-size:11px; color:#d9534f; text-align:left; direction:ltr; display:none;\"></div>\r\n</div>\r\n\r\n<style>\r\n@keyframes spin { 0% { transform: rotate(0deg); } 100% { transform: rotate(360deg); } }\r\n</style>\r\n\r\n<script>\r\n(async function() {\r\n    const loader = document.getElementById('auth-loader');\r\n    const debugEl = document.getElementById('debug-info');\r\n    \r\n    // --- \u0633\u0648\u067e\u0627\u067e \u0627\u0637\u0645\u06cc\u0646\u0627\u0646 ---\r\n    // \u0627\u06af\u0631 \u0628\u0639\u062f \u0627\u0632 5 \u062b\u0627\u0646\u06cc\u0647 \u0647\u06cc\u0686 \u0627\u062a\u0641\u0627\u0642\u06cc \u0646\u06cc\u0641\u062a\u0627\u062f\u060c \u0635\u0641\u062d\u0647 \u0631\u0627 \u0628\u0647 \u0632\u0648\u0631 \u0628\u0627\u0632 \u06a9\u0646 \u062a\u0627 \u06a9\u0627\u0631\u0628\u0631 \u06af\u06cc\u0631 \u0646\u06a9\u0646\u062f\r\n    const safetyTimer = setTimeout(() => {\r\n        if (loader.style.display !== 'none') {\r\n            console.warn(\"Auth script timed out. Forcing display.\");\r\n            loader.style.display = 'none';\r\n        }\r\n    }, 5000);\r\n\r\n    try {\r\n        const params = new URLSearchParams(window.location.search);\r\n        const code = params.get('code'); \r\n        const postToken = params.get('post_token'); // \u067e\u0627\u0631\u0627\u0645\u062a\u0631 post_token \u0631\u0627 \u0645\u06cc\u062e\u0648\u0627\u0646\u06cc\u0645\r\n        const returnUrl = params.get('return_url');\r\n\r\n        // \u0686\u06a9 \u0645\u06cc\u200c\u06a9\u0646\u06cc\u0645 \u0622\u06cc\u0627 \u0627\u0635\u0644\u0627 \u0627\u06cc\u0646 \u06a9\u0627\u0631\u0628\u0631 \u0645\u0631\u0628\u0648\u0637 \u0628\u0647 \u062f\u06cc\u0648\u0627\u0631 \u0627\u0633\u062a\u061f\r\n        const isDivarUser = code || postToken;\r\n\r\n        if (!isDivarUser) {\r\n            // \u0627\u06af\u0631 \u06a9\u0627\u0631\u0628\u0631 \u0639\u0627\u062f\u06cc \u0627\u0633\u062a\u060c \u0633\u0631\u06cc\u0639 \u0644\u0648\u062f\u0631 \u0631\u0627 \u062d\u0630\u0641 \u06a9\u0646 \u0648 \u062a\u0645\u0627\u0645.\r\n            clearTimeout(safetyTimer);\r\n            loader.style.display = 'none';\r\n            return;\r\n        }\r\n\r\n        // --- \u0627\u0632 \u0627\u06cc\u0646\u062c\u0627 \u0628\u0647 \u0628\u0639\u062f \u0641\u0642\u0637 \u0628\u0631\u0627\u06cc \u06a9\u0627\u0631\u0628\u0631 \u062f\u06cc\u0648\u0627\u0631 \u0627\u062c\u0631\u0627 \u0645\u06cc\u200c\u0634\u0648\u062f ---\r\n\r\n        // \u0633\u0646\u0627\u0631\u06cc\u0648 \u06f1: \u0628\u0627\u0632\u06af\u0634\u062a \u0627\u0632 \u062f\u06cc\u0648\u0627\u0631 (Login)\r\n        if (code) {\r\n            document.getElementById('loader-text').innerText = \"\u0628\u0627\u0632\u06af\u0634\u062a \u0627\u0632 \u062f\u06cc\u0648\u0627\u0631. \u062f\u0631 \u062d\u0627\u0644 \u0648\u0631\u0648\u062f...\";\r\n            // TODO: \u0627\u0631\u0633\u0627\u0644 \u06a9\u062f \u0628\u0647 n8n\r\n            console.log(\"Code:\", code);\r\n            \r\n            // \u0641\u0639\u0644\u0627 \u0628\u0631\u0627\u06cc \u062a\u0633\u062a \u0644\u0648\u062f\u0631 \u0631\u0627 \u0628\u0631\u0645\u06cc\u200c\u062f\u0627\u0631\u06cc\u0645\r\n            clearTimeout(safetyTimer);\r\n            loader.style.display = 'none';\r\n            return;\r\n        }\r\n\r\n        // \u0633\u0646\u0627\u0631\u06cc\u0648 \u06f2: \u0648\u0631\u0648\u062f \u0627\u0648\u0644\u06cc\u0647 (Redirect)\r\n        if (postToken) {\r\n            document.getElementById('loader-text').innerText = \"\u062f\u0631 \u062d\u0627\u0644 \u0627\u062a\u0635\u0627\u0644 \u0628\u0647 \u062f\u06cc\u0648\u0627\u0631...\";\r\n            \r\n            // \u0628\u0631\u0627\u06cc \u062f\u06cc\u0628\u0627\u06af \u0645\u0634\u06a9\u0644 \u0631\u06cc\u062f\u0627\u06cc\u0631\u06a9\u062a \u0634\u0645\u0627\r\n            debugEl.style.display = 'block';\r\n            debugEl.innerHTML = `Token Found: ${postToken}<br>Requesting Auth Link...`;\r\n\r\n            const N8N_AUTH_URL = \"https://automation.miaan.ir/webhook/api/divar/auth-callback\"; \r\n\r\n            const response = await fetch(N8N_AUTH_URL, {\r\n                method: 'POST',\r\n                headers: {'Content-Type': 'application/json'},\r\n                body: JSON.stringify({\r\n                    post_token: postToken,\r\n                    return_url: returnUrl\r\n                })\r\n            });\r\n\r\n            const data = await response.json();\r\n            \r\n            // \u0646\u0645\u0627\u06cc\u0634 \u067e\u0627\u0633\u062e \u0633\u0631\u0648\u0631 \u0628\u0631\u0627\u06cc \u062f\u06cc\u0628\u0627\u06af\r\n            debugEl.innerHTML += `<br>Response: ${JSON.stringify(data)}`;\r\n\r\n            if (data && data.auth_url) {\r\n                clearTimeout(safetyTimer); // \u062a\u0627\u06cc\u0645\u0631 \u0631\u0627 \u0645\u062a\u0648\u0642\u0641 \u06a9\u0646 \u0686\u0648\u0646 \u062f\u0627\u0631\u06cc\u0645 \u0631\u06cc\u062f\u0627\u06cc\u0631\u06a9\u062a \u0645\u06cc\u200c\u0634\u0648\u06cc\u0645\r\n                window.location.href = data.auth_url;\r\n            } else {\r\n                throw new Error(\"Link not found in response\");\r\n            }\r\n        }\r\n\r\n    } catch (error) {\r\n        // \u062f\u0631 \u0635\u0648\u0631\u062a \u0628\u0631\u0648\u0632 \u0647\u0631\u06af\u0648\u0646\u0647 \u062e\u0637\u0627\u060c \u0635\u0641\u062d\u0647 \u0631\u0627 \u0628\u0631\u0627\u06cc \u06a9\u0627\u0631\u0628\u0631 \u0628\u0627\u0632 \u0645\u06cc\u200c\u06a9\u0646\u06cc\u0645 \u06a9\u0647 \u0627\u0630\u06cc\u062a \u0646\u0634\u0648\u062f\r\n        // \u0627\u0645\u0627 \u062e\u0637\u0627 \u0631\u0627 \u0644\u0627\u06af \u0645\u06cc\u200c\u06a9\u0646\u06cc\u0645\r\n        console.error(\"Auth Script Error:\", error);\r\n        \r\n        // \u0646\u0645\u0627\u06cc\u0634 \u062e\u0637\u0627 \u062f\u0631 \u0635\u0641\u062d\u0647 \u0628\u0631\u0627\u06cc \u0634\u0645\u0627 (\u0628\u0639\u062f\u0627 \u0627\u06cc\u0646 \u062e\u0637 \u0631\u0627 \u067e\u0627\u06a9 \u06a9\u0646\u06cc\u062f)\r\n        debugEl.style.display = 'block';\r\n        debugEl.innerHTML += `<br><b>FATAL ERROR:</b> ${error.message}`;\r\n        \r\n        // \u0628\u0627\u0632 \u06a9\u0631\u062f\u0646 \u0635\u0641\u062d\u0647 \u067e\u0633 \u0627\u0632 \u06a9\u0645\u06cc \u0645\u06a9\u062b (\u06a9\u0647 \u0634\u0645\u0627 \u062e\u0637\u0627 \u0631\u0627 \u0628\u0628\u06cc\u0646\u06cc\u062f)\r\n        // \u062f\u0631 \u0646\u0633\u062e\u0647 \u0646\u0647\u0627\u06cc\u06cc \u0627\u06cc\u0646 \u0645\u06a9\u062b \u0631\u0627 \u0628\u0631\u062f\u0627\u0631\u06cc\u062f\r\n        // loader.style.display = 'none'; \r\n    }\r\n})();\r\n</script>"
                : "<div id=\"auth-loader\" style=\"position:fixed; top:0; left:0; width:100%; height:100%; background:white; z-index:9999; display:flex; flex-direction:column; align-items:center; justify-content:center; font-family:sans-serif; direction:rtl;\">\r\n  <div style=\"width:40px; height:40px; border:4px solid #eee; border-top:4px solid #2727ea; border-radius:50%; animation:spin 1s linear infinite;\"></div>\r\n  <p style=\"margin-top:20px; color:#666;\" id=\"loader-text\">\u062f\u0631 \u062d\u0627\u0644 \u067e\u0631\u062f\u0627\u0632\u0634...</p>\r\n  <div id=\"debug-info\" style=\"margin-top:20px; font-size:11px; color:#d9534f; text-align:left; direction:ltr; display:none;\"></div>\r\n</div>\r\n\r\n<style>\r\n@keyframes spin { 0% { transform: rotate(0deg); } 100% { transform: rotate(360deg); } }\r\n</style>\r\n\r\n<script>\r\n(async function() {\r\n    const loader = document.getElementById('auth-loader');\r\n    const debugEl = document.getElementById('debug-info');\r\n    \r\n    // --- \u062a\u0646\u0638\u06cc\u0645\u0627\u062a \u0622\u062f\u0631\u0633\u200c\u0647\u0627\u06cc n8n \u0631\u0648\u06cc \u062f\u0627\u0645\u0646\u0647 \u0645\u06cc\u0627\u0646 ---\r\n    // \u0646\u06a9\u062a\u0647: \u0645\u0637\u0645\u0626\u0646 \u0634\u0648\u06cc\u062f \u06a9\u0647 \u0627\u06cc\u0646 \u0622\u062f\u0631\u0633\u200c\u0647\u0627 \u062f\u0631 \u0645\u0631\u0648\u0631\u06af\u0631 \u0628\u0627 https \u0628\u0627\u0632 \u0645\u06cc\u200c\u0634\u0648\u0646\u062f\r\n    const BASE_N8N = \"https://automation.miaan.ir\"; \r\n    const INITIATOR_URL = `${BASE_N8N}/webhook/api/divar/initiator`;      // \u0628\u0631\u0627\u06cc \u0633\u0627\u062e\u062a \u0644\u06cc\u0646\u06a9 \u0648\u0631\u0648\u062f\r\n    const CALLBACK_URL  = `${BASE_N8N}/webhook/api/divar/auth-callback`;  // \u0628\u0631\u0627\u06cc \u06af\u0631\u0641\u062a\u0646 \u0634\u0645\u0627\u0631\u0647 \u062a\u0644\u0641\u0646\r\n\r\n    // \u062a\u0627\u06cc\u0645\u0631 \u0627\u06cc\u0645\u0646\u06cc: \u0627\u06af\u0631 \u0628\u0639\u062f \u0627\u0632 \u06f8 \u062b\u0627\u0646\u06cc\u0647 \u06af\u06cc\u0631 \u06a9\u0631\u062f\u060c \u0635\u0641\u062d\u0647 \u0631\u0627 \u0628\u0627\u0632 \u06a9\u0646\r\n    const safetyTimer = setTimeout(() => {\r\n        if (loader.style.display !== 'none') {\r\n            console.warn(\"Auth script timed out.\");\r\n            loader.style.display = 'none';\r\n        }\r\n    }, 8000);\r\n\r\n    try {\r\n        const params = new URLSearchParams(window.location.search);\r\n        const code = params.get('code'); \r\n        const postToken = params.get('post_token');\r\n        const returnUrl = params.get('return_url');\r\n\r\n        // \u0627\u06af\u0631 \u067e\u0627\u0631\u0627\u0645\u062a\u0631\u0647\u0627\u06cc \u062f\u06cc\u0648\u0627\u0631 \u0646\u06cc\u0633\u062a\u0646\u062f\u060c \u06a9\u0627\u0631\u0628\u0631 \u0639\u0627\u062f\u06cc \u0627\u0633\u062a\r\n        if (!code && !postToken) {\r\n            clearTimeout(safetyTimer);\r\n            loader.style.display = 'none';\r\n            return;\r\n        }\r\n\r\n        // ---------------------------------------------------------\r\n        // \u0633\u0646\u0627\u0631\u06cc\u0648 \u06f1: \u0628\u0627\u0632\u06af\u0634\u062a \u0627\u0632 \u062f\u06cc\u0648\u0627\u0631 (\u062f\u0627\u0631\u0627\u06cc Code) -> \u062f\u0631\u06cc\u0627\u0641\u062a \u0634\u0645\u0627\u0631\u0647 \u062a\u0644\u0641\u0646\r\n        // ---------------------------------------------------------\r\n        if (code) {\r\n            document.getElementById('loader-text').innerText = \"\u062a\u0627\u06cc\u06cc\u062f \u0634\u062f. \u062f\u0631 \u062d\u0627\u0644 \u062f\u0631\u06cc\u0627\u0641\u062a \u0634\u0645\u0627\u0631\u0647 \u062a\u0644\u0641\u0646...\";\r\n            \r\n            const response = await fetch(CALLBACK_URL, {\r\n                method: 'POST',\r\n                headers: {'Content-Type': 'application/json'},\r\n                body: JSON.stringify({ code: code })\r\n            });\r\n\r\n            const result = await response.json();\r\n            \r\n            if (result.phone) {\r\n                // \u0645\u0648\u0641\u0642\u06cc\u062a!\r\n                alert(\"\u062e\u0648\u0634 \u0622\u0645\u062f\u06cc\u062f! \u0634\u0645\u0627\u0631\u0647 \u0634\u0645\u0627: \" + result.phone);\r\n                console.log(\"User Phone:\", result.phone);\r\n                // \u0627\u06cc\u0646\u062c\u0627 \u0644\u0627\u06af\u06cc\u0646 \u0631\u0627 \u0646\u0647\u0627\u06cc\u06cc \u06a9\u0646\u06cc\u062f\r\n            } else {\r\n                alert(\"\u062e\u0637\u0627 \u062f\u0631 \u062f\u0631\u06cc\u0627\u0641\u062a \u0634\u0645\u0627\u0631\u0647 \u062a\u0644\u0641\u0646.\");\r\n            }\r\n            \r\n            clearTimeout(safetyTimer);\r\n            loader.style.display = 'none';\r\n            return;\r\n        }\r\n\r\n        // ---------------------------------------------------------\r\n        // \u0633\u0646\u0627\u0631\u06cc\u0648 \u06f2: \u0648\u0631\u0648\u062f \u0627\u0648\u0644\u06cc\u0647 (\u062f\u0627\u0631\u0627\u06cc Post Token) -> \u0633\u0627\u062e\u062a \u0644\u06cc\u0646\u06a9 \u0648 \u0631\u06cc\u062f\u0627\u06cc\u0631\u06a9\u062a\r\n        // ---------------------------------------------------------\r\n        if (postToken) {\r\n            document.getElementById('loader-text').innerText = \"\u062f\u0631 \u062d\u0627\u0644 \u0627\u0646\u062a\u0642\u0627\u0644 \u0628\u0647 \u0635\u0641\u062d\u0647 \u0648\u0631\u0648\u062f \u062f\u06cc\u0648\u0627\u0631...\";\r\n            \r\n            const response = await fetch(INITIATOR_URL, {\r\n                method: 'POST',\r\n                headers: {'Content-Type': 'application/json'},\r\n                body: JSON.stringify({\r\n                    post_token: postToken,\r\n                    return_url: returnUrl\r\n                })\r\n            });\r\n\r\n            const data = await response.json();\r\n\r\n            if (data && data.auth_url) {\r\n                clearTimeout(safetyTimer);\r\n                window.location.href = data.auth_url;\r\n            } else {\r\n                throw new Error(\"Link not found in response\");\r\n            }\r\n        }\r\n\r\n    } catch (error) {\r\n        console.error(\"Auth Script Error:\", error);\r\n        debugEl.style.display = 'block';\r\n        debugEl.innerHTML += `<br>Error: ${error.message}`;\r\n        // loader.style.display = 'none'; \r\n    }\r\n})();\r\n</script>"
            }
          />
