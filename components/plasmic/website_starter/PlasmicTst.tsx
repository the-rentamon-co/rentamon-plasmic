        ...
        >
          ...
          >
            <Embed
              ...
              code={
                "<script type=\"module\">\r\n  import { initializeApp } from \"https://www.gstatic.com/firebasejs/9.23.0/firebase-app.js\";\r\n  import { getMessaging, getToken, onTokenRefresh } from \"https://www.gstatic.com/firebasejs/9.23.0/firebase-messaging.js\";\r\n\r\n  // \u06f1. \u062a\u0646\u0638\u06cc\u0645\u0627\u062a \u0641\u0627\u06cc\u0631\u0628\u06cc\u0633 \u0634\u0645\u0627\r\n  const firebaseConfig = {\r\n    apiKey: \"AIzaSyCwfbUiQNPQSyL48d0It3MgFOoTwF6AHN4\",\r\n    authDomain: \"miaan-notify-mn5436.firebaseapp.com\",\r\n    projectId: \"miaan-notify-mn5436\",\r\n    messagingSenderId: \"553708011126\",\r\n    appId: \"1:553708011126:web:dcdff7eacd0ea7b3296957\"\r\n  };\r\n\r\n  const app = initializeApp(firebaseConfig);\r\n  const messaging = getMessaging(app);\r\n\r\n  // \u06f2. \u062a\u0627\u0628\u0639 \u06a9\u0645\u06a9\u06cc \u0628\u0631\u0627\u06cc \u062e\u0648\u0627\u0646\u062f\u0646 \u06a9\u0648\u06a9\u06cc usso_access_token\r\n  function getCookie(name) {\r\n    const value = `; ${document.cookie}`;\r\n    const parts = value.split(`; ${name}=`);\r\n    if (parts.length === 2) return parts.pop().split(';').shift();\r\n    return null;\r\n  }\r\n\r\n  // \u06f3. \u062a\u0627\u0628\u0639 \u0627\u0635\u0644\u06cc \u0627\u0631\u0633\u0627\u0644 \u062a\u0648\u06a9\u0646 \u0628\u0647 \u0628\u06a9\u200c\u0627\u0650\u0646\u062f\r\n  async function sendTokenToBackend(fcmToken) {\r\n    const userToken = getCookie('usso_access_token');\r\n    const backendUrl = 'YOUR_N8N_WEBHOOK_URL'; // <--- \u0622\u062f\u0631\u0633 n8n \u0631\u0627 \u0627\u06cc\u0646\u062c\u0627 \u0628\u06af\u0630\u0627\u0631\u06cc\u062f\r\n\r\n    console.log(\"Checking if token needs to be sent...\");\r\n\r\n    try {\r\n      const response = await fetch(backendUrl, {\r\n        method: 'POST',\r\n        headers: {\r\n          'Content-Type': 'application/json',\r\n          'fcm-token': fcmToken,            // \u0627\u0631\u0633\u0627\u0644 \u062a\u0648\u06a9\u0646 \u0646\u0648\u062a\u06cc\u0641 \u062f\u0631 \u0647\u062f\u0631\r\n          'user-token': userToken || ''     // \u0627\u0631\u0633\u0627\u0644 \u062a\u0648\u06a9\u0646 \u06a9\u0627\u0631\u0628\u0631 \u062f\u0631 \u0647\u062f\u0631\r\n        }\r\n      });\r\n\r\n      if (response.ok) {\r\n        console.log(\"Token sent successfully.\");\r\n        localStorage.setItem('last_sent_fcm_token', fcmToken);\r\n      }\r\n    } catch (error) {\r\n      console.error(\"Error sending token to backend:\", error);\r\n    }\r\n  }\r\n\r\n  // \u06f4. \u062f\u0631\u06cc\u0627\u0641\u062a \u062a\u0648\u06a9\u0646 \u0648 \u0645\u062f\u06cc\u0631\u06cc\u062a \u062a\u063a\u06cc\u06cc\u0631\u0627\u062a\r\n  async function initNotificationLogic() {\r\n    try {\r\n      // \u062f\u0631\u062e\u0648\u0627\u0633\u062a \u0627\u062c\u0627\u0632\u0647 \u0627\u0632 \u06a9\u0627\u0631\u0628\u0631\r\n      const status = await Notification.requestPermission();\r\n      if (status === 'granted') {\r\n        const currentToken = await getToken(messaging, {\r\n          vapidKey: 'YOUR_VAPID_KEY' // <--- \u0627\u06cc\u0646\u062c\u0627 VAPID Key \u0631\u0627 \u0627\u0632 \u06a9\u0646\u0633\u0648\u0644 \u0641\u0627\u06cc\u0631\u0628\u06cc\u0633 \u0628\u06af\u0630\u0627\u0631\u06cc\u062f\r\n        });\r\n\r\n        if (currentToken) {\r\n          const lastToken = localStorage.getItem('last_sent_fcm_token');\r\n          \r\n          // \u0627\u06af\u0631 \u062a\u0648\u06a9\u0646 \u062c\u062f\u06cc\u062f \u0627\u0633\u062a \u06cc\u0627 \u0628\u0627 \u0642\u0628\u0644\u06cc \u0641\u0631\u0642 \u062f\u0627\u0631\u062f\u060c \u0627\u0631\u0633\u0627\u0644 \u06a9\u0646\r\n          if (currentToken !== lastToken) {\r\n            await sendTokenToBackend(currentToken);\r\n          } else {\r\n            console.log(\"Token is already up to date.\");\r\n          }\r\n        }\r\n      }\r\n    } catch (error) {\r\n      console.error('Notification Error:', error);\r\n    }\r\n  }\r\n\r\n  // \u0627\u062c\u0631\u0627\u06cc \u0645\u0646\u0637\u0642 \u0647\u0646\u06af\u0627\u0645 \u0628\u0627\u0644\u0627 \u0622\u0645\u062f\u0646 \u0627\u067e\u0644\u06cc\u06a9\u06cc\u0634\u0646\r\n  initNotificationLogic();\r\n\r\n</script>"
              }
            />
