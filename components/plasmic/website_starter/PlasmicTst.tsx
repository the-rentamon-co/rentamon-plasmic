        ...
        >
          ...
          >
            <Embed
              ...
              code={
                "<script type=\"module\">\r\n  import { initializeApp } from \"https://www.gstatic.com/firebasejs/9.22.0/firebase-app.js\";\r\n  import { getMessaging, getToken, onMessage } from \"https://www.gstatic.com/firebasejs/9.22.0/firebase-messaging.js\";\r\n\r\n  // 1. \u062a\u0646\u0638\u06cc\u0645\u0627\u062a \u0641\u0627\u06cc\u0631\u0628\u06cc\u0633 (\u062f\u0642\u06cc\u0642\u0627\u064b \u0647\u0645\u0627\u0646 \u0645\u0642\u0627\u062f\u06cc\u0631 \u0641\u0627\u06cc\u0644 \u0642\u0628\u0644\u06cc \u0631\u0627 \u0627\u06cc\u0646\u062c\u0627 \u0628\u06af\u0630\u0627\u0631\u06cc\u062f)\r\n  const firebaseConfig = {\r\n    apiKey: \"AIzaSyCwfbUiQNPQSyL48d0It3MgFOoTwF6AHN4\",\r\n    authDomain: \"miaan-notify-mn5436.firebaseapp.com\",\r\n    projectId: \"miaan-notify-mn5436\",\r\n    storageBucket: \"miaan-notify-mn5436.firebasestorage.app\",\r\n    messagingSenderId: \"553708011126\",\r\n    appId: \"1:553708011126:web:dcdff7eacd0ea7b3296957\"\r\n  };\r\n\r\n  // \u0631\u0627\u0647 \u0627\u0646\u062f\u0627\u0632\u06cc \u0641\u0627\u06cc\u0631\u0628\u06cc\u0633\r\n  const app = initializeApp(firebaseConfig);\r\n  const messaging = getMessaging(app);\r\n\r\n  // \u062a\u0627\u0628\u0639 \u06a9\u0645\u06a9\u06cc \u0628\u0631\u0627\u06cc \u062e\u0648\u0627\u0646\u062f\u0646 \u06a9\u0648\u06a9\u06cc (\u0628\u0631\u0627\u06cc \u067e\u06cc\u062f\u0627 \u06a9\u0631\u062f\u0646 usso_access_token)\r\n  function getCookie(name) {\r\n    const value = `; ${document.cookie}`;\r\n    const parts = value.split(`; ${name}=`);\r\n    if (parts.length === 2) return parts.pop().split(';').shift();\r\n    return null;\r\n  }\r\n\r\n  // \u062a\u0627\u0628\u0639 \u0630\u062e\u06cc\u0631\u0647 \u062a\u0648\u06a9\u0646 \u062f\u0631 \u0644\u0648\u06a9\u0627\u0644 \u0627\u0633\u062a\u0648\u0631\u06cc\u062c \u0648 \u06a9\u0648\u06a9\u06cc (\u0646\u06a9\u062a\u0647 \u06f3)\r\n  function saveTokenLocally(token) {\r\n    if(!token) return;\r\n    \r\n    // \u0630\u062e\u06cc\u0631\u0647 \u062f\u0631 LocalStorage\r\n    localStorage.setItem('fcm_token', token);\r\n    \r\n    // \u0630\u062e\u06cc\u0631\u0647 \u062f\u0631 Cookie (\u0628\u0627 \u0627\u0646\u0642\u0636\u0627\u06cc 1 \u0633\u0627\u0644)\r\n    const d = new Date();\r\n    d.setTime(d.getTime() + (365*24*60*60*1000));\r\n    let expires = \"expires=\"+ d.toUTCString();\r\n    document.cookie = \"fcm_token=\" + token + \";\" + expires + \";path=/\";\r\n  }\r\n\r\n  // \u062a\u0627\u0628\u0639 \u0627\u0635\u0644\u06cc \u0627\u0631\u0633\u0627\u0644 \u0628\u0647 \u0628\u06a9\u200c\u0627\u0646\u062f (\u0646\u06a9\u062a\u0647 \u06f1 \u0648 \u06f2)\r\n  async function sendTokenToBackend(fcmToken) {\r\n    const ussoToken = getCookie('usso_access_token');\r\n    \r\n    if (!ussoToken) {\r\n      console.warn('\u06a9\u0627\u0631\u0628\u0631 \u0644\u0627\u06af\u06cc\u0646 \u0646\u06cc\u0633\u062a \u06cc\u0627 \u06a9\u0648\u06a9\u06cc usso \u06cc\u0627\u0641\u062a \u0646\u0634\u062f. \u062a\u0648\u06a9\u0646 \u0627\u0631\u0633\u0627\u0644 \u0646\u0634\u062f.');\r\n      // \u0628\u0633\u062a\u0647 \u0628\u0647 \u0644\u0627\u062c\u06cc\u06a9 \u0628\u06cc\u0632\u0646\u0633\u060c \u0634\u0627\u06cc\u062f \u0628\u062e\u0648\u0627\u0647\u06cc\u062f \u062f\u0631 \u0627\u06cc\u0646 \u062d\u0627\u0644\u062a \u0647\u0645 \u0628\u0641\u0631\u0633\u062a\u06cc\u062f\u060c \u0627\u0645\u0627 \u0637\u0628\u0642 \u062f\u0631\u062e\u0648\u0627\u0633\u062a \u0634\u0645\u0627 \u062a\u0648\u06a9\u0646 \u06a9\u0627\u0631\u0628\u0631 \u0627\u0644\u0632\u0627\u0645\u06cc \u0627\u0633\u062a.\r\n      return; \r\n    }\r\n\r\n    const endpoint = \"https://second-n8n.darkube.app/webhook/v1/devices/sync\";\r\n\r\n    try {\r\n      const response = await fetch(endpoint, {\r\n        method: 'POST',\r\n        headers: {\r\n          'Content-Type': 'application/json',\r\n          // \u0627\u0631\u0633\u0627\u0644 \u062a\u0648\u06a9\u0646 \u0646\u0648\u062a\u06cc\u0641\u06cc\u06a9\u06cc\u0634\u0646 \u062f\u0631 \u0647\u062f\u0631\r\n          'x-fcm-token': fcmToken,\r\n          // \u0627\u0631\u0633\u0627\u0644 \u062a\u0648\u06a9\u0646 \u06a9\u0627\u0631\u0628\u0631 \u062f\u0631 \u0647\u062f\u0631 (\u0645\u0639\u0645\u0648\u0644\u0627 Authorization \u0627\u0633\u062a\u0627\u0646\u062f\u0627\u0631\u062f \u0627\u0633\u062a)\r\n          'Authorization': `Bearer ${ussoToken}`,\r\n          // \u0645\u062d\u0636 \u0627\u062d\u062a\u06cc\u0627\u0637 \u0646\u0627\u0645 \u06a9\u0648\u06a9\u06cc \u0631\u0627 \u0647\u0645 \u0628\u0647 \u0639\u0646\u0648\u0627\u0646 \u0647\u062f\u0631 \u0627\u062e\u062a\u0635\u0627\u0635\u06cc \u0645\u06cc\u200c\u0641\u0631\u0633\u062a\u06cc\u0645\r\n          'x-usso-token': ussoToken\r\n        },\r\n        body: JSON.stringify({\r\n          token: fcmToken,\r\n          platform: 'pwa-apk'\r\n        })\r\n      });\r\n      \r\n      if(response.ok) {\r\n        console.log('Token synced successfully with n8n');\r\n      } else {\r\n        console.error('Failed to sync token', response.status);\r\n      }\r\n    } catch (error) {\r\n      console.error('Error sending token to backend:', error);\r\n    }\r\n  }\r\n\r\n  // \u062a\u0627\u0628\u0639 \u0627\u0635\u0644\u06cc \u062f\u0631\u062e\u0648\u0627\u0633\u062a \u0645\u062c\u0648\u0632 \u0648 \u062f\u0631\u06cc\u0627\u0641\u062a \u062a\u0648\u06a9\u0646\r\n  function initNotification() {\r\n    Notification.requestPermission().then(permission => {\r\n      if (permission === 'granted') {\r\n        console.log('Notification permission granted.');\r\n        \r\n        // \u062f\u0631\u06cc\u0627\u0641\u062a \u062a\u0648\u06a9\u0646\r\n        getToken(messaging, { \r\n            // \u06a9\u0644\u06cc\u062f VAPID \u0631\u0627 \u0627\u06cc\u0646\u062c\u0627 \u0628\u06af\u0630\u0627\u0631\u06cc\u062f. \u0627\u06cc\u0646 \u06a9\u0644\u06cc\u062f \u0631\u0627 \u0627\u0632 \u062a\u0628 Cloud Messaging \u062f\u0631 \u062a\u0646\u0638\u06cc\u0645\u0627\u062a \u06a9\u0646\u0633\u0648\u0644 \u0641\u0627\u06cc\u0631\u0628\u06cc\u0633 \u0628\u06af\u06cc\u0631\u06cc\u062f (Web Push certificates)\r\n            vapidKey: 'BPBCMzaOwuDnklPI_8EXu6x30lu0-eq0fcZ058u1fXWbHxicUr0fn8MdpyLFdP5QQIOgiIg9zZtVsyCrr7rV15k' \r\n        }).then((currentToken) => {\r\n          if (currentToken) {\r\n            console.log('FCM Token:', currentToken);\r\n            \r\n            // 1. \u0630\u062e\u06cc\u0631\u0647 \u0633\u0627\u0632\u06cc\r\n            saveTokenLocally(currentToken);\r\n            \r\n            // 2. \u0627\u0631\u0633\u0627\u0644 \u0628\u0647 \u0633\u0631\u0648\u0631\r\n            sendTokenToBackend(currentToken);\r\n            \r\n          } else {\r\n            console.log('No registration token available. Request permission to generate one.');\r\n          }\r\n        }).catch((err) => {\r\n          console.log('An error occurred while retrieving token. ', err);\r\n        });\r\n      } else {\r\n        console.log('Unable to get permission to notify.');\r\n      }\r\n    });\r\n  }\r\n\r\n  // \u0627\u062c\u0631\u0627 \u062f\u0631 \u0632\u0645\u0627\u0646 \u0644\u0648\u062f \u0635\u0641\u062d\u0647\r\n  initNotification();\r\n\r\n  // \u0647\u0646\u062f\u0644 \u06a9\u0631\u062f\u0646 \u067e\u06cc\u0627\u0645 \u062f\u0631 \u0632\u0645\u0627\u0646\u06cc \u06a9\u0647 \u0633\u0627\u06cc\u062a \u0628\u0627\u0632 \u0627\u0633\u062a (Foreground)\r\n  onMessage(messaging, (payload) => {\r\n    console.log('Message received in foreground: ', payload);\r\n    const notificationTitle = payload.notification.title;\r\n    const notificationOptions = {\r\n      body: payload.notification.body,\r\n      icon: 'https://media.rentamon.com/img%2Flogo-miaan%2Fsign-blue-small.png',\r\n      tag: 'miaan-single-notification-tag' // \u0646\u06a9\u062a\u0647 \u06f4\r\n    };\r\n    \r\n    // \u0646\u0645\u0627\u06cc\u0634 \u0646\u0648\u062a\u06cc\u0641\u06cc\u06a9\u06cc\u0634\u0646 \u062d\u062a\u06cc \u0648\u0642\u062a\u06cc \u06a9\u0627\u0631\u0628\u0631 \u062f\u0627\u062e\u0644 \u0633\u0627\u06cc\u062a \u0627\u0633\u062a\r\n    new Notification(notificationTitle, notificationOptions);\r\n  });\r\n  \r\n  // \u0646\u06a9\u062a\u0647 \u06f2 (\u062e\u06cc\u0644\u06cc \u0645\u0647\u0645): \u0647\u0646\u062f\u0644 \u06a9\u0631\u062f\u0646 \u062a\u063a\u06cc\u06cc\u0631 \u062a\u0648\u06a9\u0646 \u062a\u0648\u0633\u0637 \u0641\u0627\u06cc\u0631\u0628\u06cc\u0633\r\n  // \u0645\u062a\u0627\u0633\u0641\u0627\u0646\u0647 \u062f\u0631 \u0648\u0631\u0698\u0646 \u06f9 \u0645\u0627\u0698\u0648\u0644\u0627\u0631 \u0631\u0648\u06cc\u062f\u0627\u062f onTokenRefresh \u062d\u0630\u0641 \u0634\u062f\u0647 \u0648 \u062e\u0648\u062f getToken \u0645\u062f\u06cc\u0631\u06cc\u062a \u0645\u06cc\u06a9\u0646\u062f.\r\n  // \u0627\u0645\u0627 \u0628\u0631\u0627\u06cc \u0627\u0637\u0645\u06cc\u0646\u0627\u0646\u060c \u0645\u0627 \u0647\u0631 \u0628\u0627\u0631 \u06a9\u0647 \u0635\u0641\u062d\u0647 \u0644\u0648\u062f \u0645\u06cc\u0634\u0648\u062f getToken \u0631\u0627 \u0635\u062f\u0627 \u0645\u06cc\u0632\u0646\u06cc\u0645 (\u062f\u0631 initNotification)\r\n  // \u06a9\u0647 \u0627\u06af\u0631 \u062a\u0648\u06a9\u0646 \u0639\u0648\u0636 \u0634\u062f\u0647 \u0628\u0627\u0634\u062f\u060c \u062a\u0648\u06a9\u0646 \u062c\u062f\u06cc\u062f \u0631\u0627 \u0628\u0631\u0645\u06cc\u06af\u0631\u062f\u0627\u0646\u062f \u0648 \u0645\u0627 \u0622\u067e\u062f\u06cc\u062a \u0645\u06cc\u06a9\u0646\u06cc\u0645.\r\n  \r\n</script>"
              }
            />
