        ...
        >
          ...
          >
            <Embed
              ...
              code={
                '<script type="module">\r\n  // --------------------------------------------------------\r\n  // 1. CONFIGURATION\r\n  // --------------------------------------------------------\r\n  import { initializeApp } from "https://www.gstatic.com/firebasejs/10.7.1/firebase-app.js";\r\n  import { getMessaging, getToken, onMessage } from "https://www.gstatic.com/firebasejs/10.7.1/firebase-messaging.js";\r\n\r\n  // \u062a\u0646\u0638\u06cc\u0645\u0627\u062a \u0641\u0627\u06cc\u0631\u0628\u06cc\u0633 \u0648\u0628 (\u0627\u0632 \u06a9\u0646\u0633\u0648\u0644 \u0641\u0627\u06cc\u0631\u0628\u06cc\u0633 \u0628\u0631\u062f\u0627\u0631\u06cc\u062f)\r\n  const firebaseConfig = {\r\n    apiKey: "AIzaSyCwfbUiQNPQSyL48d0It3MgFOoTwF6AHN4",\r\n    authDomain: "miaan-notify-mn5436.firebaseapp.com", \r\n    projectId: "miaan-notify-mn5436",\r\n    storageBucket: "miaan-notify-mn5436.firebasestorage.app",\r\n    messagingSenderId: "553708011126", \r\n    appId: "1:553708011126:web:dcdff7eacd0ea7b3296957" \r\n  };\r\n\r\n  const VAPID_KEY = "BPBCMzaOwuDnklPI_8EXu6x30lu0-eq0fcZ058u1fXWbHxicUr0fn8MdpyLFdP5QQIOgiIg9zZtVsyCrr7rV15k"; // \u06a9\u0644\u06cc\u062f \u0639\u0645\u0648\u0645\u06cc \u0631\u0627 \u0627\u06cc\u0646\u062c\u0627 \u0628\u06af\u0630\u0627\u0631\u06cc\u062f\r\n  const BACKEND_URL = "https://second-n8n.darkube.app/webhook/v1/devices/sync";\r\n  const MANDATORY_ICON = "https://media.rentamon.com/img%2Flogo-miaan%2Fsign-blue-small.png";\r\n\r\n  // Initialize Firebase\r\n  const app = initializeApp(firebaseConfig);\r\n  const messaging = getMessaging(app);\r\n\r\n  // --------------------------------------------------------\r\n  // 2. HELPER: GET COOKIE\r\n  // --------------------------------------------------------\r\n  function getCookie(name) {\r\n    const value = `; ${document.cookie}`;\r\n    const parts = value.split(`; ${name}=`);\r\n    if (parts.length === 2) return parts.pop().split(\';\').shift();\r\n    return null;\r\n  }\r\n\r\n  // --------------------------------------------------------\r\n  // 3. BACKEND SYNC LOGIC (\u0628\u0627 \u0647\u062f\u0631\u0647\u0627\u06cc \u0627\u0633\u062a\u0627\u0646\u062f\u0627\u0631\u062f)\r\n  // --------------------------------------------------------\r\n  async function syncTokenToBackend(fcmToken) {\r\n    const ussoToken = getCookie("usso_access_token");\r\n\r\n    // \u062d\u062a\u06cc \u0627\u06af\u0631 \u062a\u0648\u06a9\u0646 \u06cc\u0648\u0632\u0631 \u0646\u0628\u0648\u062f\u060c \u062a\u0648\u06a9\u0646 \u0646\u0648\u062a\u06cc\u0641 \u0631\u0648 \u0628\u0641\u0631\u0633\u062a (\u0637\u0628\u0642 \u062f\u0631\u062e\u0648\u0627\u0633\u062a \u0642\u0628\u0644\u06cc \u06a9\u0647 \u06af\u0641\u062a\u06cc \u0647\u0645\u06cc\u0634\u0647 \u0622\u0645\u0627\u062f\u0647 \u0628\u0627\u0634\u06cc\u0645)\r\n    // \u0627\u0645\u0627 \u0644\u0627\u06af \u0645\u06cc\u200c\u0627\u0646\u062f\u0627\u0632\u06cc\u0645\r\n    if (!ussoToken) console.warn("\u26a0\ufe0f [FCM] usso_access_token not found, syncing FCM token only.");\r\n\r\n    try {\r\n      console.log("\ud83d\udd04 [FCM] Syncing tokens to backend...");\r\n      \r\n      const response = await fetch(BACKEND_URL, {\r\n        method: "POST",\r\n        headers: {\r\n          "Content-Type": "application/json",\r\n          "x-fcm-token": fcmToken, // \u0627\u0631\u0633\u0627\u0644 \u062a\u0648\u06a9\u0646 \u0646\u0648\u062a\u06cc\u0641 \u062f\u0631 \u0647\u062f\u0631 \u0627\u062e\u062a\u0635\u0627\u0635\u06cc\r\n          "Authorization": ussoToken ? `Bearer ${ussoToken}` : "" // \u0627\u0633\u062a\u0627\u0646\u062f\u0627\u0631\u062f \u0627\u0631\u0633\u0627\u0644 \u062a\u0648\u06a9\u0646 \u06a9\u0627\u0631\u0628\u0631\r\n        },\r\n        body: JSON.stringify({\r\n          fcm_token: fcmToken,\r\n          usso_access_token: ussoToken, // \u062f\u0631 \u0628\u0627\u062f\u06cc \u0647\u0645 \u0645\u06cc\u200c\u0641\u0631\u0633\u062a\u06cc\u0645 \u0645\u062d\u0636 \u0627\u0637\u0645\u06cc\u0646\u0627\u0646\r\n          device_type: "pwa-apk",\r\n          platform: "web",\r\n          timestamp: new Date().toISOString()\r\n        })\r\n      });\r\n\r\n      if (response.ok) {\r\n        console.log("\u2705 [FCM] Backend sync successful.");\r\n        localStorage.setItem("fcm_synced_token", fcmToken);\r\n        document.cookie = `fcm_token_notify=${fcmToken}; path=/; max-age=31536000; SameSite=Lax`;\r\n      } else {\r\n        console.error("\u274c [FCM] Backend sync failed:", response.status);\r\n      }\r\n    } catch (error) {\r\n      console.error("\u274c [FCM] Network error during sync:", error);\r\n    }\r\n  }\r\n\r\n  // --------------------------------------------------------\r\n  // 4. MAIN INIT LOGIC\r\n  // --------------------------------------------------------\r\n  async function initPush() {\r\n    try {\r\n      // \u062b\u0628\u062a \u0633\u0631\u0648\u06cc\u0633 \u0648\u0631\u06a9\u0631 \u0628\u0627 \u0627\u0633\u06a9\u0648\u067e \u0631\u0648\u062a\r\n      const registration = await navigator.serviceWorker.register("/firebase-messaging-sw.js", { scope: \'/\' });\r\n      console.log("\u2705 [SW] Service Worker Registered.");\r\n\r\n      // \u062f\u0631\u062e\u0648\u0627\u0633\u062a \u0627\u062c\u0627\u0632\u0647\r\n      const permission = await Notification.requestPermission();\r\n      if (permission !== "granted") {\r\n        console.warn("\u26a0\ufe0f [FCM] Permission denied.");\r\n        return;\r\n      }\r\n\r\n      // \u062f\u0631\u06cc\u0627\u0641\u062a \u062a\u0648\u06a9\u0646\r\n      const currentToken = await getToken(messaging, { \r\n        vapidKey: VAPID_KEY,\r\n        serviceWorkerRegistration: registration \r\n      });\r\n\r\n      if (currentToken) {\r\n        // \u0628\u0631\u0631\u0633\u06cc \u062a\u063a\u06cc\u06cc\u0631 \u062a\u0648\u06a9\u0646\r\n        const cachedToken = localStorage.getItem("fcm_synced_token");\r\n        \r\n        if (currentToken !== cachedToken) {\r\n          console.log("\ud83c\udd95 [FCM] New token detected.");\r\n          await syncTokenToBackend(currentToken);\r\n        } else {\r\n          // \u0628\u0631\u0627\u06cc \u0627\u0637\u0645\u06cc\u0646\u0627\u0646 \u0686\u06a9 \u0645\u06cc\u200c\u06a9\u0646\u06cc\u0645 \u0627\u06af\u0631 usso \u0633\u062a \u0634\u062f\u0647 \u0648\u0644\u06cc \u0642\u0628\u0644\u0627 \u0633\u06cc\u0646\u06a9 \u0646\u0634\u062f\u0647 \u0628\u0627\u0632 \u0647\u0645 \u0628\u0641\u0631\u0633\u062a\u06cc\u0645\r\n          // (\u0645\u06cc\u200c\u062a\u0648\u0627\u0646\u06cc\u062f \u0627\u06cc\u0646 \u062e\u0637 \u0631\u0627 \u0628\u0631\u062f\u0627\u0631\u06cc\u062f \u0627\u06af\u0631 \u062a\u0631\u0627\u0641\u06cc\u06a9 \u0633\u0631\u0648\u0631 \u0645\u0647\u0645 \u0627\u0633\u062a)\r\n          // await syncTokenToBackend(currentToken); \r\n          console.log("OK [FCM] Token is up to date.");\r\n        }\r\n      } \r\n    } catch (err) {\r\n      console.error("\u274c [FCM] Init error:", err);\r\n    }\r\n  }\r\n\r\n  // --------------------------------------------------------\r\n  // 5. FOREGROUND MESSAGE HANDLER\r\n  // \u0646\u06a9\u062a\u0647 \u0645\u0647\u0645: \u0627\u06cc\u0646 \u0628\u062e\u0634 \u0628\u0627\u0639\u062b \u0645\u06cc\u200c\u0634\u0648\u062f \u0648\u0642\u062a\u06cc \u06a9\u0627\u0631\u0628\u0631 \u062f\u0631 \u0628\u0631\u0646\u0627\u0645\u0647 \u0627\u0633\u062a \u0647\u0645 \u0646\u0648\u062a\u06cc\u0641 \u0628\u06cc\u0627\u06cc\u062f\r\n  // --------------------------------------------------------\r\n  onMessage(messaging, (payload) => {\r\n    console.log("\ud83d\udd14 [FCM] Foreground message:", payload);\r\n    \r\n    const { title, body } = payload.notification || {};\r\n    const data = payload.data || {};\r\n    \r\n    // \u0627\u0648\u0644\u0648\u06cc\u062a \u0628\u0627 \u062a\u0627\u06cc\u062a\u0644 \u062f\u06cc\u062a\u0627\u06cc\u06cc \u0627\u0633\u062a (\u0628\u0631\u0627\u06cc \u0641\u0644\u06a9\u0633\u06cc\u0628\u06cc\u0644\u06cc\u062a\u06cc \u0628\u06cc\u0634\u062a\u0631 \u0628\u0627 n8n)\r\n    const notificationTitle = title || data.title || "\u067e\u06cc\u0627\u0645 \u062c\u062f\u06cc\u062f";\r\n    const notificationOptions = {\r\n      body: body || data.body || "\u0634\u0645\u0627 \u06cc\u06a9 \u067e\u06cc\u0627\u0645 \u062c\u062f\u06cc\u062f \u062f\u0627\u0631\u06cc\u062f",\r\n      icon: MANDATORY_ICON, // \u0627\u062c\u0628\u0627\u0631 \u0622\u06cc\u06a9\u0648\u0646\r\n      data: {\r\n        url: data.url || data.link || "/" // \u0644\u06cc\u0646\u06a9\r\n      }\r\n    };\r\n\r\n    // \u0627\u0633\u062a\u0641\u0627\u062f\u0647 \u0627\u0632 \u0633\u0631\u0648\u06cc\u0633 \u0648\u0631\u06a9\u0631 \u0628\u0631\u0627\u06cc \u0646\u0645\u0627\u06cc\u0634 \u0646\u0648\u062a\u06cc\u0641\u06cc\u06a9\u06cc\u0634\u0646\r\n    // \u0627\u06cc\u0646 \u06a9\u0627\u0631 \u0628\u0627\u0639\u062b \u0645\u06cc\u200c\u0634\u0648\u062f \u06a9\u0644\u06cc\u06a9 \u0631\u0648\u06cc \u0622\u0646 \u062a\u0648\u0633\u0637 SW \u0647\u0646\u062f\u0644 \u0634\u0648\u062f (\u0648 \u062f\u06cc\u067e \u0644\u06cc\u0646\u06a9 \u06a9\u0627\u0631 \u06a9\u0646\u062f)\r\n    if (navigator.serviceWorker && navigator.serviceWorker.ready) {\r\n      navigator.serviceWorker.ready.then((registration) => {\r\n        registration.showNotification(notificationTitle, notificationOptions);\r\n      });\r\n    }\r\n  });\r\n\r\n  // \u0627\u062c\u0631\u0627\r\n  initPush();\r\n</script>'
              }
            />
            ...
            >
              {
                "\u0627\u06cc\u0646\u062c\u0627 \u06a9\u0644\u06cc\u06a9 \u06a9\u0646 \u062a\u0627 \u0646\u0648\u062a\u06cc\u0641 \u0628\u0647\u062a \u0628\u062f\u06cc\u0645."
              }
            </Button>
          </div>
        </div>
