...
import Button2 from "../../Button2"; // plasmic-import: JOcGbQ6IffYW/component
...
import sty from "./PlasmicModal.module.css"; // plasmic-import: I9fGrD8jmEnh/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_gj7ASABKW7p8"]]: true })}
              ...
              {renderPlasmicSlot({
                defaultContents: (
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox__vaEgN)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
            ...
            {$props.showFooter ? (
              ...
              >
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(projectcss.all, sty.freeBox__fpiRw)}
                    >
                      <Button2
                        color={"muted"}
                        label={
