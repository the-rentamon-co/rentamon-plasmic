...
export type PlasmicStatusesConnectionsNeo__VariantMembers = {};
export type PlasmicStatusesConnectionsNeo__VariantsArgs = {};
type VariantPropType = keyof PlasmicStatusesConnectionsNeo__VariantsArgs;
export const PlasmicStatusesConnectionsNeo__VariantProps =
  new Array<VariantPropType>();

export type PlasmicStatusesConnectionsNeo__ArgsType = {};
type ArgPropType = keyof PlasmicStatusesConnectionsNeo__ArgsType;
export const PlasmicStatusesConnectionsNeo__ArgProps = new Array<ArgPropType>();

export type PlasmicStatusesConnectionsNeo__OverridesType = {
  root?: Flex__<"div">;
...
export interface DefaultStatusesConnectionsNeoProps {}
...
function PlasmicStatusesConnectionsNeo__RenderFunc(props: {
  variants: PlasmicStatusesConnectionsNeo__VariantsArgs;
  args: PlasmicStatusesConnectionsNeo__ArgsType;
  overrides: PlasmicStatusesConnectionsNeo__OverridesType;
  forNode?: string;
}) {
    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
                ...
                <ApiRequest
                  ...
                  loadingDisplay={
                    <React.Fragment>
                      <PlasmicImg__
                        alt={""}
                        className={classNames(sty.img__wgYfk)}
                        displayHeight={
                          hasVariant(globalVariants, "screen", "mobile")
                            ? "40px"
                            : "50px"
                              ...
                              >
                                {(() => {
                                  ...
                                  >
                                    ...
                                    <PlasmicImg__
                                      alt={""}
                                      className={classNames(sty.img__lifkz)}
                                      displayHeight={"auto"}
                                      displayMaxHeight={"none"}
                                      displayMaxWidth={"100%"}
                                      displayMinHeight={"0"}
                          ...
                          {(() => {
                            ...
                            >
                              ...
                              >
                                <PlasmicImg__
                                  alt={""}
                                  className={classNames(sty.img__rB0K)}
                                  displayHeight={
                                    hasVariant(
                                      globalVariants,
                                      "screen",
                      ...
                      return (
                        <div
                          ...
                          onClick={async event => {
                            ...
                            $steps["goToConnectionsNeo"] =
                              currentItems.status !== "true"
                                ? (() => {
                                    const actionArgs = {
                                      destination: `/connections-neo?step=${(() => {
                                        try {
                                          return (() => {
                                ...
                                : undefined;
                            if (
                              $steps["goToConnectionsNeo"] != null &&
                              typeof $steps["goToConnectionsNeo"] ===
                                "object" &&
                              typeof $steps["goToConnectionsNeo"].then ===
                                "function"
                            ) {
                              $steps["goToConnectionsNeo"] =
                                await $steps["goToConnectionsNeo"];
                            }
                          ...
                          {(() => {
                            ...
                            >
                              ...
                              >
                                <PlasmicImg__
                                  alt={""}
                                  className={classNames(sty.img__gePro)}
                                  displayHeight={"auto"}
                                  displayMaxHeight={"none"}
                                  displayMaxWidth={"100%"}
                                  displayMinHeight={"0"}
          ...
          <SideEffect
            className={classNames("__wab_instance", sty.sideEffect___6M9Qo)}
            onMount={async () => {
              const $steps = {};
          ...
          <SideEffect
            className={classNames("__wab_instance", sty.sideEffect__aSoV7)}
            onMount={async () => {
              const $steps = {};
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicStatusesConnectionsNeo__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicStatusesConnectionsNeo__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicStatusesConnectionsNeo__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicStatusesConnectionsNeo__ArgProps,
          internalVariantPropNames: PlasmicStatusesConnectionsNeo__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicStatusesConnectionsNeo__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicStatusesConnectionsNeo";
  } else {
    func.displayName = `PlasmicStatusesConnectionsNeo.${nodeName}`;
  }
  return func;
}

export const PlasmicStatusesConnectionsNeo = Object.assign(
  // Top-level PlasmicStatusesConnectionsNeo renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicStatusesConnectionsNeo
    internalVariantProps: PlasmicStatusesConnectionsNeo__VariantProps,
    internalArgProps: PlasmicStatusesConnectionsNeo__ArgProps,

    pageMetadata: generateDynamicMetadata(wrapQueriesWithLoadingProxy({}), {
      pageRoute: "/statuses-neo",
      pagePath: "/statuses-neo",
      params: {},
      query: {}
    })
  }
...
export default PlasmicStatusesConnectionsNeo;
/* prettier-ignore-end */
