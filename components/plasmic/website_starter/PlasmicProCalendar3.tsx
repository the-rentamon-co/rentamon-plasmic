  ...
  return (
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          <SideEffect
            className={classNames("__wab_instance", sty.sideEffect___6R2Rr)}
            onMount={async () => {
              const $steps = {};
          ...
          <SideEffect
            className={classNames("__wab_instance", sty.sideEffect___9FvG)}
            onMount={async () => {
              const $steps = {};
          ...
          >
            ...
            <div className={classNames(projectcss.all, sty.freeBox__sqbt5)}>
              <ApiRequest
          ...
          <AntdModal
            ...
            title={
              <div className={classNames(projectcss.all, sty.freeBox__rSSD)}>
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__iEjUx)}
                  displayHeight={"20px"}
          ...
          >
            <div
              className={classNames(projectcss.all, sty.freeBox__shpOj)}
              onClick={async event => {
                const $steps = {};
              }}
            >
              <div
                className={classNames(projectcss.all, sty.freeBox__lhr4E)}
                onClick={async event => {
                  const $steps = {};
              ...
              >
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__cPfRe)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
            ...
            <div className={classNames(projectcss.all, sty.freeBox__ourkf)}>
              <div className={classNames(projectcss.all, sty.freeBox___0Kn0E)}>
                <div className={classNames(projectcss.all, sty.freeBox__lS9C)}>
                  <div
                    className={classNames(projectcss.all, sty.freeBox__qweYn)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
                    ...
                    <div
                      className={classNames(projectcss.all, sty.freeBox__vWzuI)}
                    >
                      <Embed
              ...
              <div className={classNames(projectcss.all, sty.freeBox___7Zsu8)}>
                <div
                  className={classNames(
                    projectcss.all,
                    sty.freeBox__idDJv,
                      ...
                      >
                        ...
                        >
                          ...
                          {(() => {
                            ...
                            <PlasmicImg__
                              alt={""}
                              className={classNames(sty.img___5EDn8)}
                              displayHeight={
                                hasVariant(
                                  globalVariants,
                                  "screen",
                ...
                >
                  {(() => {
                    ...
                    >
                      <PlasmicImg__
                        alt={""}
                        className={classNames(sty.img__p70Lc)}
                        displayHeight={
                          hasVariant(globalVariants, "screen", "smallMobile")
                            ? "60px"
                            : hasVariant(globalVariants, "screen", "mobile")
                  ...
                  {(() => {
                    ...
                    <div
                      className={classNames(projectcss.all, sty.freeBox__aDcR)}
                      onClick={async event => {
                        const $steps = {};
          ...
          {(() => {
            ...
            <div className={classNames(projectcss.all, sty.freeBox__oXkrq)}>
              <div className={classNames(projectcss.all, sty.freeBox__cO58E)} />
            </div>
          ) : null}
          <Calendar23
          ...
          {false ? (
            ...
            >
              ...
              <div className={classNames(projectcss.all, sty.freeBox__cz5K)}>
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__jtKlx)}
                  displayHeight={
                    hasVariant(globalVariants, "screen", "mobile")
                      ? "30px"
                      : "34px"
          ...
          {false ? (
            ...
            >
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__teLzQ)}
                displayHeight={"auto"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
          ...
          <div className={classNames(projectcss.all, sty.freeBox__nIxVa)}>
            <ClarityRntComponent
          ...
          <AntdModal
            ...
            trigger={null}
          >
            <div className={classNames(projectcss.all, sty.freeBox___1BBdR)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
            ...
            <div
              className={classNames(projectcss.all, sty.freeBox__nNl0R)}
              onClick={async event => {
                const $steps = {};
