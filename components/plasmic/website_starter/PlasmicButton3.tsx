...
import sty from "./PlasmicButton3.module.css"; // plasmic-import: 5VoVqiGmU3In/css
...
function PlasmicButton3__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox___5RLn, {
          [sty.freeBoxcolor_neutral___5RLn0KaVb]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxroundedFull___5RLnUimel]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge___5RLnCZnc]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall___5RLnRxStK]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large___5RLn2Vo0U]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small___5RLnzUsRc]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered___5RLnCUerp]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
          [sty.freeBoxtype_bordered_color_success___5RLnCUerpEQlHm]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered")
        })}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__hdlfp, {
            [sty.freeBoxcolor_neutral__hdlfp0KaVb]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft__hdlfp0KaVbOuDyw]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart__hdlfPdov9K]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__hdlfpcZnc]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__hdlfp2Vo0U]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__hdlfPzUsRc]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__hdlfpcUerp]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__fksk6)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__vW0Os, {
            [sty.freeBoxiconEnd__vW0OsGrXvW]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__vW0OsCZnc]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__vW0Os2Vo0U]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__vW0OszUsRc]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__zolIf)}
                role={"img"}
              />
            ),
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicButton3__VariantsArgs, ReservedPropsType> &
