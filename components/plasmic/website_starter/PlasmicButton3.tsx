...
function PlasmicButton3__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames("all", sty.freeBox___5RLn, {
      ...
      >
        <div
          className={classNames("all", sty.freeBox__hdlfp, {
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames("all", sty.svg__fksk6)}
                role={"img"}
              />
            ),
        ...
        {renderPlasmicSlot({
          defaultContents: (
            <div className={classNames("all", "__wab_text", sty.text__lxhWh)}>
              {"Text"}
            </div>
          ),
          value: args.label,
        ...
        <div
          className={classNames("all", sty.freeBox__vW0Os, {
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames("all", sty.svg__zolIf)}
                role={"img"}
              />
            ),
