...
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: BKay7WngMlXQ/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: RayFurEZTrhA/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__yCuMk, {
          [sty.freeBoxiconEnd__yCuMkSzzNb]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__yCuMkinarN]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__yCuMkBmSm0]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox___7Bf9I, {
            [sty.freeBoxiconStart___7Bf9IinarN]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine___7Bf9IBmSm0]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__t7KrT)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__hhWZg, {
            [sty.freeBoxiconEnd__hhWZgSzzNb]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__hhWZginarN]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__uqIwb)}
                role={"img"}
              />
            ),
