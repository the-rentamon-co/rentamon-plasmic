...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames("all", sty.freeBox__yCuMk, {
      ...
      >
        <div
          className={classNames("all", sty.freeBox___7Bf9I, {
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames("all", sty.svg__t7KrT)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames("all", sty.freeBox__hhWZg, {
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames("all", sty.svg__uqIwb)}
                role={"img"}
              />
            ),
